...
description: "You can easily refund orders on Tarifia — both in full or in parts."
---

No matter what refund policy you offer to customers, Tarifia makes it easy to issue both full and partial refunds, so you can deliver the customer experience and refund policy you want.

<Note>
**Tarifia can issue refunds on your behalf**
...
This applies even if you have a "no refunds" policy: keeping chargebacks low protects your account, so Tarifia may still refund proactively. See [Chargeback Management](/merchant-of-record/account-reviews#chargeback-management) for the wider context.
</Note>
...
Example: an order of \$30 costs ~\$1.60 in fees to Tarifia. You can still refund the customer \$30, but the ~\$1.60 fee stays deducted from your balance.
</Warning>
...
Tarifia **automatically calculates the corresponding tax** to refund based on the order's tax rate. For partial refunds, tax is prorated against the refunded portion; for a full refund, the entire remaining tax is returned.
