...
Tarifia has a built in feature to view and manage your Customers.
...
We have dedicated API endpoints that work with the `external_id` field, so you don't even have to store the internal Tarifia ID in your system.
