...
Trials are a great way to let potential customers experience your product before committing to a subscription. With Tarifia, you can easily set up free trials for your subscription products.
...
Before a trial ends, Tarifia emails the customer to remind them that they're about to be charged. This keeps conversions transparent and avoids surprise charges that often end in chargebacks.
...
You can turn trial conversion reminders off under [**Settings → Customer notifications**](https://tarifia.sh/to/dashboard/settings) if you prefer to handle that communication yourself.
...
When this feature is enabled, Tarifia tracks trial redemptions using:
...
1. Open your organization's [**Settings**](https://tarifia.sh/to/dashboard/settings) page
