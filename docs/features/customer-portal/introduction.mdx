...
- **Failed payment recovery.** When a subscription renewal fails, the portal is where customers update their card so they don't lose access. Because Tarifia is PCI-compliant, you never have to handle card details yourself.
...
<AccordionGroup>
  ...
  <Accordion title="Can I customize the look and feel of the Customer Portal?">
    Not the hosted portal at `tarifia.sh/<your-org-slug>/portal` — it's
    intentionally consistent across all Tarifia organizations.
  ...
  <Accordion title="How do customers sign in to the portal?">
    ...
    purchase or subscribe — Tarifia emails them a one-time code to confirm.
  ...
  <Accordion title="Do I need to send customers a link to the portal myself?">
    You don't have to. Tarifia already includes a link to the Customer Portal in
  ...
  <Accordion title="What happens if a customer's payment method fails?">
    The customer receives an email from Tarifia letting them know, with a link to
    the Customer Portal where they can update their default payment method.
    Once they do, Tarifia automatically retries the charge.
