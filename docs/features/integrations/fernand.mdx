---
title: "Tarifia Integration in Fernand"
sidebarTitle: "Fernand"
description: "Learn how to sync customer and payment data from Tarifia to Fernand."
---
...
After connecting your [Tarifia](https://tarifia.sh/) account to Fernand, you’ll be able to see customer payment information and product access details directly within each customer conversation.
...
## How to connect Fernand with Tarifia
...
2. Click on **Connect Tarifia**.
3. You'll be redirected to Tarifia to authorize the connection.
4. Once approved, Fernand will begin syncing customer data automatically.

That’s it! You’ll now see Tarifia customer info directly in Fernand's conversation list and sidebar.

---

## How to automate your inbox with Tarifia data

Once Tarifia is connected, you can create automation rules in Fernand based on Tarifia data.
...
<Steps>
  ...
  <Step title="Select a condition">
    Now add a condition based on Tarifia data. For example:
...
If you ever want to disconnect Tarifia from your Fernand workspace:
<Steps>
<Step title="Go to the Integrations page."></Step>
<Step title="Click Disconnect next to Tarifia."></Step>
</Steps>

Deleting your organization on Fernand will also remove the Tarifia integration automatically.
