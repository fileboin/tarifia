---
title: "Affonso Affiliates with Tarifia"
sidebarTitle: "Affonso (Affiliates)"
---

This guide explains how to integrate
[Affonso](https://affonso.io)'s affiliate marketing software with your Tarifia
...
### 1. Create a Tarifia Access Token for Affonso

First, you'll need to create an API token in Tarifia that Affonso can use to communicate with your account:

1. Login to your **Tarifia Dashboard**
2. Navigate to [**Settings**](https://tarifia.sh/to/dashboard/settings)
...
<video controls width="600">
  <source
  src="https://affonso-videos.s3.eu-central-1.amazonaws.com/Connect_Tarifia_Affonso_1.mp4"
  type="video/mp4" />
</video>


### 2. Set Up Webhooks in Tarifia

After connecting your Tarifia account with Affonso, you'll [receive a webhook URL and secret from Affonso](https://affonso.io/app/affiliate-program/connect). Add these to your Tarifia account:

1. Go to [**Settings → Webhooks**](https://tarifia.sh/to/dashboard/settings/webhooks) in your Tarifia Dashboard
...
<video controls width="600">
  <source
  src="https://affonso-videos.s3.eu-central-1.amazonaws.com/Connect_Tarifia_Affonso_2.mp4"
  type="video/mp4" />
</video>
...
### 5. Pass Referral Data to Tarifia Checkout
...
// Create checkout session with Tarifia
...
3. When the user makes a purchase, the referral ID is passed to Tarifia as metadata
4. Tarifia's webhook notifies Affonso about the purchase
...
More details about the integration: [Tarifia Affiliate Program](https://affonso.io/tarifia-affiliate-program)
