...
To create a meter, [open the Meters page](https://tarifia.sh/to/dashboard/products/meters) and click the "Create Meter" button.
...
A filter is a set of clauses that are combined using conjunctions. They're used to filter events that you've ingested into Tarifia.
