...
Tarifia offers an ingestion framework to work with Tarifia's event ingestion API.
...
We're always looking for ways to improve our ingestion strategies. Feel free to contribute — [Tarifia Ingestion SDK](https://github.com/tarifiasource/tarifia-ingestion).
