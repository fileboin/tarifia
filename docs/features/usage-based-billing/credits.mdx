...
Credits is the way to pre-pay for usage in Tarifia. It allows you to give your customers the ability to pre-pay for usage instead of risk getting a hefty bill at the end of the month.
...
<Warning>
  Tarifia doesn't block usage if the customer exceeds their balance. You're
