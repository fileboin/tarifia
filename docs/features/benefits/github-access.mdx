...
With Tarifia you can seamlessly offer your customers and subscribers automated access to private GitHub repositories.
...
You first need to `Connect your GitHub Account` and install a dedicated Tarifia App for this benefit across the repositories you want to use it with.
...
Once you've authorized our dedicated GitHub App for this feature you'll be redirected back to Tarifia and the benefit form - now connected and updated.
