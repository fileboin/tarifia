...
Automating Discord server invites and roles for customers or subscribers is super easy and powerful with Tarifia.
...
Click on `Connect your Discord server`. You'll be redirected to Discord where you can grant the Tarifia App for your desired server.
...
Ability to kick members who have this benefit and connected Discord with Tarifia.

### **Create Invite**

Ability to invite members who purchase a product or subscribes to a tier with this benefit.

You're now redirected back to Tarifia and can finish setting up the Discord benefit on our end.
