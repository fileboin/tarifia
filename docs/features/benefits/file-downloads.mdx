...
You can easily offer customers and subscribers access to downloadable files with Tarifia.
...
Deleting a file permanently deletes it from Tarifia and our S3 buckets except for the metadata. Disable the file instead if you don't want it permanently deleted.
