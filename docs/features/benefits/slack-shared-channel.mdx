...
When a customer is granted the benefit, they're asked for the email address of an admin in their own Slack workspace. Tarifia creates the channel, invites your team members, posts your welcome message, and sends a Slack Connect invitation to that admin. Once they accept, the shared channel appears in their workspace and you can start talking right away.
