...
```bash
curl -X POST https://api.tarifia.sh/v1/checkouts/ \
...
Want to help us review translations for an upcoming language? Reach out at [translations@tarifia.sh](mailto:translations@tarifia.sh).
...
- Open an issue on [GitHub](https://github.com/tarifiasource/tarifia)
- Email us at [translations@tarifia.sh](mailto:translations@tarifia.sh)
