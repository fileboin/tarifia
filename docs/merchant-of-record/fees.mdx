...
Tarifia offers a free Starter plan plus three optional paid plans — Pro, Growth, and Scale — that lower your variable rate and prioritize your support inquiries. You can switch between plans anytime, and your rate adjusts immediately.
...
Organizations created before **May 27, 2026** stay on the Early Member rate indefinitely. This was the rate we offered while Tarifia was catching up on feature parity with other Merchant of Record providers, and we've committed to honoring it for everyone who signed up under it.
...
However, we continuously work to proactively reduce the rate of chargebacks across Tarifia to be at or lower than industry standards.

Credit card networks impose monitoring programs, penalties and higher chargeback costs for sellers with high chargeback rates (~0.7%+). Since Tarifia is the Merchant of Record, we therefore always monitor and proactively prevent our rate coming close to these thresholds.
...
While payouts may incur fees charged by our payout provider (Stripe), Tarifia does not add any extra fees or markup. These are strictly Stripe's fees, and Tarifia does not profit from them.

In addition, Tarifia offers manual withdrawals for developers. Keeping you in control of when to issue payouts.

*Unless you have a Tarifia balance that you haven't withdrawn for several months, at which point we'll eventually need to trigger a payout on your behalf.*
