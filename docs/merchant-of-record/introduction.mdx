...
Merchants of Record offer yet another layer of convenient abstraction to facilitate digital orders on top of the underlying PSPs and transactions. E.g Tarifia is built on Stripe (+ more PSPs in the future).
...
- ✅ The platform (Tarifia) handles international taxes by being a reseller of your digital goods & services. Of course, without being in the way of your relationship with your customers.
...
So how does Tarifia offer a Merchant of Record (MoR) service and handle international sale taxes? All other Merchants of Record simply state they handle it internationally - don't worry about it. We do too.
...
1. **Capturing**. Charging the Swedish consumer \$12.5/month and saving \$2.5/month for the Swedish tax authorities. Stripe Tax is an excellent service to automate this and the one Tarifia uses today.
...
Tarifia is registered in jurisdictions around the world and works with global accounting firms to monitor sales volumes, register in new markets as thresholds are reached, and handle filings and remittance on an ongoing basis. You don't need to track where you owe taxes, or when — that's our job.
...
We consider MoR a key value-add to Tarifia, but not the sole reason for Tarifia to exist. Our ambition is to be the easiest way to monetize for developers. However, we're never going to be the right solution for all use cases. But we'll always salute and help anyone who ships software - regardless of billing platform.

## Frequently Asked Questions

<AccordionGroup>
  <Accordion title="Why doesn't my accounting software recognize Tarifia's EU OSS VAT number (EU372061545)?">
