...
Feature requests & bugs can be reported through the "Feedback" button found in the sidebar, bottom left of your Tarifia dashboard.

## Email

You can reach us at [support@tarifia.sh](mailto:support@tarifia.sh).
...
More information on our account reviewal process can be found in our [Account Reviews documentation](https://tarifia.sh/docs/merchant-of-record/account-reviews)
