---
title: "Guides"
description: "Step-by-step walkthroughs for implementing common Tarifia patterns."
---
...
Looking to wire Tarifia into a specific stack? See the [Next.js](/guides/nextjs), [Laravel](/guides/laravel), and [Encore](/guides/encore) guides under **Integrate**.

## Requesting a new guide

Missing something? [Open an issue on tarifiasource/tarifia](https://github.com/tarifiasource/tarifia/issues/new/choose) and tell us what you're trying to build.
