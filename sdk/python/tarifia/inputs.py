...
class BenefitSlackSharedChannelCreateProperties(typing.TypedDict):
    ...
    """Tarifia Slack integration to use for this benefit."""
...
You can store up to **50 key-value pairs**."""
    ...
    """If you plan to embed the checkout session, set this to the Origin of the embedding page. It'll allow the Tarifia iframe to communicate with the parent page."""
...
class EventCreateCustomer(typing.TypedDict):
    ...
    """The ID of the parent event. Can be either a Tarifia event ID (UUID) or an external event ID."""
...
class OrganizationCreate(typing.TypedDict):
    ...
    """Additional, private, business details Tarifia needs about active organizations for compliance (KYC)."""
...
class OrganizationDetails(typing.TypedDict):
    ...
    """How the organization will integrate and use Tarifia."""
...
You can store up to **50 key-value pairs**."""
    ...
    external_customer_id: str
    """The ID of the customer in your system to create the subscription for. It must already exist in Tarifia."""
