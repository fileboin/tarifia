...
class BalanceCreditOrderEvent:
    """An event created by Tarifia when an order is paid via customer balance."""
    ...
    """ID of the customer in your Tarifia organization associated with the event."""
    ...
    """The source of the event. `system` events are created by Tarifia. `user` events are the one you create through our ingestion API."""
...
class BalanceDisputeEvent:
    """An event created by Tarifia when an order is disputed."""
...
class BalanceDisputeReversalEvent:
    """An event created by Tarifia when a dispute is won and funds are reinstated."""
...
class BalanceOrderEvent:
    """An event created by Tarifia when an order is paid."""
...
class BalanceRefundEvent:
    """An event created by Tarifia when an order is refunded."""
...
class BalanceRefundReversalEvent:
    """An event created by Tarifia when a refund is reverted."""
...
class BenefitCycledEvent:
    """An event created by Tarifia when a benefit is cycled."""
...
class BenefitGrantedEvent:
    """An event created by Tarifia when a benefit is granted to a customer."""
...
class BenefitRevokedEvent:
    """An event created by Tarifia when a benefit is revoked from a customer."""
...
class BenefitSlackSharedChannelProperties:
    ...
    """Tarifia Slack integration linked to this benefit."""
...
class BenefitUpdatedEvent:
    """An event created by Tarifia when a benefit is updated."""
...
class Checkout:
    ...
    external_customer_id: str | None
    """ID of the customer in your system. If a matching customer exists on Tarifia, the resulting order will be linked to this customer. Otherwise, a new customer will be created with this external ID set."""
...
class CheckoutCreatedEvent:
    """An event created by Tarifia when a checkout is created."""
...
class CustomerCreatedEvent:
    """An event created by Tarifia when a customer is created."""
...
class CustomerDeletedEvent:
    """An event created by Tarifia when a customer is deleted."""
...
class CustomerUpdatedEvent:
    """An event created by Tarifia when a customer is updated."""
...
class MeterCreditEvent:
    """An event created by Tarifia when credits are added to a customer meter."""
...
class MeterResetEvent:
    """An event created by Tarifia when a customer meter is reset."""
...
class OrderVoidedEvent:
    """An event created by Tarifia when an order is voided."""
...
class SubscriptionBillingPeriodUpdatedEvent:
    """An event created by Tarifia when a subscription billing period is updated."""
...
class SubscriptionCanceledEvent:
    """An event created by Tarifia when a subscription is canceled."""
...
class SubscriptionCreatedEvent:
    """An event created by Tarifia when a subscription is created."""
...
class SubscriptionCycledEvent:
    """An event created by Tarifia when a subscription is cycled."""
...
class SubscriptionPastDueEvent:
    """An event created by Tarifia when a subscription becomes past due."""
...
class SubscriptionProductUpdatedEvent:
    """An event created by Tarifia when a subscription changes the product."""
...
class SubscriptionReactivatedEvent:
    """An event created by Tarifia when a past due subscription is recovered."""
...
class SubscriptionRevokedEvent:
    """An event created by Tarifia when a subscription is revoked from a customer."""
...
class SubscriptionSeatsUpdatedEvent:
    """An event created by Tarifia when a the seats on a subscription is changed."""
...
class SubscriptionUncanceledEvent:
    """An event created by Tarifia when a subscription cancellation is reversed."""
...
class SubscriptionUpdateClearedEvent:
    """An event created by Tarifia when a pending subscription update is cleared without being applied."""
...
class SubscriptionUpdatedEvent:
    """An event created by Tarifia when a subscription is updated."""
