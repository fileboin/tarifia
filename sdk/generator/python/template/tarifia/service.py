...
from tarifia.base import AsyncServiceBase, SyncServiceBase
{% if service.methods | selectattr("response_type", "equalto", "json") | list %}
from tarifia.base import parse_response_json
{% endif %}
{% if service.methods | selectattr("response_type", "equalto", "text") | list %}
from tarifia.base import parse_response_text
{% endif %}
{% if service.methods | selectattr("response_type", "equalto", "none") | list %}
from tarifia.base import parse_response_none
{% endif %}
{% if imports.enum %}
...
{% endfor %}
    TarifiaNetworkError: Raised when a network error occurs while making the request.
    TarifiaServerError: Raised when the server returns a 5xx error response.
        """
