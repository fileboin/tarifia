...
class BenefitSlackSharedChannelSubscriberTypedDict(TypedDict):
    id: str
    ...
    properties: BenefitSlackSharedChannelSubscriberPropertiesTypedDict
    type: Literal["slack_shared_channel"]


class BenefitSlackSharedChannelSubscriber(BaseModel):
    id: str
    r"""The ID of the benefit."""
