...
class CustomerBenefitGrantSlackSharedChannelTypedDict(TypedDict):
    created_at: datetime
    ...
    benefit: BenefitSlackSharedChannelSubscriberTypedDict
...
class CustomerBenefitGrantSlackSharedChannel(BaseModel):
    created_at: datetime
    r"""Creation timestamp of the object."""
