...
class SubscriptionUpdateClearedEventTypedDict(TypedDict):
    r"""An event created by Tarifia when a pending subscription update is cleared without being applied."""
    ...
    r"""ID of the customer in your Tarifia organization associated with the event."""
    ...
    metadata: SubscriptionUpdateClearedMetadataTypedDict
    ...
    r"""The source of the event. `system` events are created by Tarifia. `user` events are the one you create through our ingestion API."""
    name: Literal["subscription.update_cleared"]
    r"""The name of the event."""


class SubscriptionUpdateClearedEvent(BaseModel):
    r"""An event created by Tarifia when a pending subscription update is cleared without being applied."""
    ...
    NAME: Annotated[
        Annotated[
            Literal["subscription.update_cleared"],
            AfterValidator(validate_const("subscription.update_cleared")),
        ],
