...
class OrderVoidedEventTypedDict(TypedDict):
    r"""An event created by Tarifia when an order is voided."""
    ...
    metadata: OrderVoidedMetadataTypedDict
    ...
    name: Literal["order.voided"]
    r"""The name of the event."""


class OrderVoidedEvent(BaseModel):
    r"""An event created by Tarifia when an order is voided."""
    ...
    NAME: Annotated[
        Annotated[
            Literal["order.voided"], AfterValidator(validate_const("order.voided"))
        ],
