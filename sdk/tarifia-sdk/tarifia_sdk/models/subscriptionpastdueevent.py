...
class SubscriptionPastDueEventTypedDict(TypedDict):
    r"""An event created by Tarifia when a subscription becomes past due."""
    ...
    metadata: SubscriptionPastDueMetadataTypedDict
    ...
    name: Literal["subscription.past_due"]
    r"""The name of the event."""


class SubscriptionPastDueEvent(BaseModel):
    r"""An event created by Tarifia when a subscription becomes past due."""
