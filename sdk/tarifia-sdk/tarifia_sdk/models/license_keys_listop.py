...
LicenseKeyStatusFilterTypedDict = TypeAliasType(
    "LicenseKeyStatusFilterTypedDict", Union[LicenseKeyStatus, List[LicenseKeyStatus]]
)
r"""Filter by license key status."""


LicenseKeyStatusFilter = TypeAliasType(
    "LicenseKeyStatusFilter", Union[LicenseKeyStatus, List[LicenseKeyStatus]]
)
r"""Filter by license key status."""
...
class LicenseKeysListRequestTypedDict(TypedDict):
    ...
    r"""Filter by benefit ID."""
    status: NotRequired[Nullable[LicenseKeyStatusFilterTypedDict]]
    r"""Filter by license key status."""
...
class LicenseKeysListRequest(BaseModel):
    ...
    status: Annotated[
        OptionalNullable[LicenseKeyStatusFilter],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""Filter by license key status."""
    ...
    def serialize_model(self, handler):
        optional_fields = ["organization_id", "benefit_id", "status", "page", "limit"]
        nullable_fields = ["organization_id", "benefit_id", "status"]
        null_default_fields = []
