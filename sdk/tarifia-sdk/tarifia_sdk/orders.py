...
class Orders(BaseSDK):
    ...
    def finalize(
        ...
        *,
        id: str,
        order_finalize: Optional[
            Union[models.OrderFinalize, models.OrderFinalizeTypedDict]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        **Scopes**: `orders:write`
        ...
        request = models.OrdersFinalizeRequest(
            id=id,
            order_finalize=utils.get_pydantic_model(
                order_finalize, Optional[models.OrderFinalize]
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.order_finalize,
                False,
                True,
                "json",
                Optional[models.OrderFinalize],
            ),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="orders:finalize",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
            error_status_codes=["402", "403", "404", "412", "422", "4XX", "5XX"],
            retry_config=retry_config,
        )
        ...
        if utils.match_response(http_res, "402", "application/json"):
            response_data = unmarshal_json_response(
                models.OrdersFinalizeResponse402OrdersFinalizeUnion, http_res
            )
            raise models.OrdersFinalizeResponse402OrdersFinalize(
                response_data, http_res
            )
        if utils.match_response(http_res, "403", "application/json"):
            response_data = unmarshal_json_response(
                models.OrdersFinalizeResponse403OrdersFinalizeUnion, http_res
            )
            raise models.OrdersFinalizeResponse403OrdersFinalize(
                response_data, http_res
            )
        if utils.match_response(http_res, "404", "application/json"):
            response_data = unmarshal_json_response(
        ...
        if utils.match_response(http_res, "412", "application/json"):
            response_data = unmarshal_json_response(models.OrderNotDraftData, http_res)
            raise models.OrderNotDraft(response_data, http_res)
        if utils.match_response(http_res, "422", "application/json"):
            response_data = unmarshal_json_response(
                models.HTTPValidationErrorData, http_res
            )
    ...
    def receipt(
        ...
        **Scopes**: `orders:read`
        ...
        request = models.OrdersReceiptRequest(
            id=id,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.OrderReceipt, http_res)
