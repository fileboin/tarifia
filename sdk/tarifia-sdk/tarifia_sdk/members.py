...
class Members(BaseSDK):
    ...
    def get_member_by_external_id(
        ...
        **Scopes**: `members:read` `members:write`
        ...
        req = self._build_request(
            method="GET",
            path="/v1/members/external/{external_id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="members:get_member_by_external_id",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
    ...
    async def get_member_by_external_id_async(
        self,
        *,
        external_id: str,
        customer_id: OptionalNullable[str] = UNSET,
        ...
        **Scopes**: `members:write`
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="members:update_member_by_external_id",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
    ...
    async def update_member_by_external_id_async(
        self,
        *,
        external_id: str,
        member_update: Union[models.MemberUpdate, models.MemberUpdateTypedDict],
        ...
        **Scopes**: `members:write`
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="members:delete_member_by_external_id",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
    ...
    async def delete_member_by_external_id_async(
        self,
        *,
        external_id: str,
        customer_id: OptionalNullable[str] = UNSET,
