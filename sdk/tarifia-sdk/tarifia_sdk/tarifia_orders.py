...
class TarifiaOrders(BaseSDK):
    ...
    def receipt(
        ...
        *,
        security: Union[
            models.CustomerPortalOrdersReceiptSecurity,
            models.CustomerPortalOrdersReceiptSecurityTypedDict,
        ],
        id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.CustomerOrderReceipt]:
        r"""Get Order Receipt
        ...
        request = models.CustomerPortalOrdersReceiptRequest(
            id=id,
        )
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.CustomerPortalOrdersReceiptSecurity
            ),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="customer_portal:orders:receipt",
                oauth2_scopes=None,
                security_source=security,
            ),
            request=req,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.CustomerOrderReceipt, http_res)
