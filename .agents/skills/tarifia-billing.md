# Tarifia Billing System

Comprehensive guide to Tarifia's billing infrastructure, covering entities, flows, Stripe integration, and benefit provisioning.
...
### Checkout
**File:** `server/tarifia/models/checkout.py`
...
### CheckoutLink
**File:** `server/tarifia/models/checkout_link.py`
...
### Order
**File:** `server/tarifia/models/order.py`
...
| `platform_fee_amount` | int | Tarifia's fee |
...
### Subscription
**File:** `server/tarifia/models/subscription.py`
...
### Transaction
**File:** `server/tarifia/models/transaction.py`
...
### Payment
**File:** `server/tarifia/models/payment.py`
...
### Refund
**File:** `server/tarifia/models/refund.py`
...
### Customer
**File:** `server/tarifia/models/customer.py`
...
**Files:** `server/tarifia/models/product.py`, `server/tarifia/models/product_price.py`
...
### BillingEntry
**File:** `server/tarifia/models/billing_entry.py`
...
### SubscriptionService
**File:** `server/tarifia/subscription/service.py`
...
### OrderService
**File:** `server/tarifia/order/service.py`
...
### CheckoutService
**File:** `server/tarifia/checkout/service.py`
...
### PaymentService
**File:** `server/tarifia/payment/service.py`
...
### RefundService
**File:** `server/tarifia/refund/service.py`
...
### BenefitGrantService
**File:** `server/tarifia/benefit/grant/service.py`
...
### Subscription Tasks
**File:** `server/tarifia/subscription/tasks.py`
...
### Order Tasks
**File:** `server/tarifia/order/tasks.py`
...
**File:** `server/tarifia/integrations/stripe/tasks.py`
...
### Benefit Tasks
**File:** `server/tarifia/benefit/tasks.py`
...
### Checkout Tasks
**File:** `server/tarifia/checkout/tasks.py`
...
### Payout Tasks
**File:** `server/tarifia/payout/tasks.py`
...
### Refund Tasks
**File:** `server/tarifia/refund/tasks.py`
...
### Webhook Endpoints
**File:** `server/tarifia/integrations/stripe/endpoints.py`
...
### StripeService
**File:** `server/tarifia/integrations/stripe/service.py`
...
### Stripe Integration
```
server/tarifia/integrations/stripe/
