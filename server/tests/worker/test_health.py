...
import tarifia.worker._health as health_module
from tarifia.worker._health import (
    handle_server_error,
    health,
)
...
class TestIsSchedulerHealthy:
    def test_healthy_before_first_heartbeat(self) -> None:
        import tarifia.worker.scheduler as scheduler_module
        from tarifia.worker.scheduler import _is_scheduler_healthy
    ...
    def test_unhealthy_with_stale_heartbeat(self) -> None:
        import tarifia.worker.scheduler as scheduler_module
        from tarifia.worker.scheduler import (
