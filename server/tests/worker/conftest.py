...
Tarifia infrastructure (database, Minio, etc.). We override the session-scoped
...
# Set up test environment before any tarifia imports
os.environ["TARIFIA_ENV"] = "testing"
