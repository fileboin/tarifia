...
import tarifia.tasks  # noqa: F401  (registers actors with the broker)
from tarifia.config import settings
from tarifia.logging import CorrelationID
...
class TestFlushGate:
    async def test_disabled_routes_everything_to_redis(
        ...
        send_jobs = mocker.patch("tarifia.worker._enqueue._sqs.send_jobs")
