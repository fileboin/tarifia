...
from tarifia.worker._metrics import PrometheusMiddleware
...
class TestPrometheusMiddlewareWithStubBroker:
    def test_middleware_integrated_with_broker(
        ...
        mock_executions = mocker.patch("tarifia.worker._metrics.TASK_EXECUTIONS")
        mock_duration = mocker.patch("tarifia.worker._metrics.TASK_DURATION")
    ...
    def test_middleware_records_retries(
        ...
        mock_retries = mocker.patch("tarifia.worker._metrics.TASK_RETRIES")
        mock_executions = mocker.patch("tarifia.worker._metrics.TASK_EXECUTIONS")
...
class TestPrometheusMiddlewareDirectCalls:
    ...
    def test_after_process_message_records_failure(
        ...
        mock_executions = mocker.patch("tarifia.worker._metrics.TASK_EXECUTIONS")
        mocker.patch("tarifia.worker._metrics.TASK_DURATION")
    ...
    def test_after_process_message_removes_start_time(
        ...
        mocker.patch("tarifia.worker._metrics.TASK_DURATION")
        mocker.patch("tarifia.worker._metrics.TASK_EXECUTIONS")
