...
from tarifia.customer_portal.schemas.customer import CustomerPortalCustomerUpdate
from tarifia.customer_portal.service.customer import customer as customer_service
...
class TestUpdate:
    ...
    async def test_billing_name_update(
        ...
        updated_customer = await customer_service.update(
            ...
            customer,
            CustomerPortalCustomerUpdate(
                billing_name="Tarifia Software Inc.",
            ),
        )

        assert updated_customer.billing_name == "Tarifia Software Inc."
