...
from tarifia.models import Customer, CustomerSeat, Organization, Subscription
...
def email_sender_mock(mocker: MockerFixture) -> MagicMock:
    mock = MagicMock()
    mocker.patch("tarifia.customer_seat.service.send_seat_invitation_email", new=mock)
    return mock
