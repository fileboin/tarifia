...
from tarifia.models import Customer, Order, Organization, Payment, Product, Transaction
from tarifia.models.transaction import Processor, ProcessorFeeType, TransactionType
from tarifia.postgres import AsyncSession
from tarifia.transaction.service.processor_fee import (
...
def stripe_service_mock(mocker: MockerFixture) -> MagicMock:
    ...
    mocker.patch("tarifia.transaction.service.processor_fee.stripe_service", new=mock)
    return mock
