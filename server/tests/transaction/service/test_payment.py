...
from tarifia.models import Customer, Transaction
...
def stripe_service_mock(mocker: MockerFixture) -> MagicMock:
    ...
    mocker.patch("tarifia.transaction.service.payment.stripe_service", new=mock)
    return mock


@pytest.fixture
def enqueue_job_mock(mocker: MockerFixture) -> MagicMock:
    return mocker.patch("tarifia.transaction.service.payment.enqueue_job")
