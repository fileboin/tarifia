...
def enqueue_email_mock(mocker: MockerFixture) -> MagicMock:
    return mocker.patch(
        "tarifia.personal_access_token.service.enqueue_email_template", autospec=True
    )
