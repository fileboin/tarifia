...
from tarifia.tax.tax_id import InvalidTaxID, TaxID, TaxIDFormat, validate_tax_id
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("123456789", "GE", ("123456789", TaxIDFormat.ge_vat)),
        ("GE123456789", "GE", ("123456789", TaxIDFormat.ge_vat)),
        ("ge123456789", "GE", ("123456789", TaxIDFormat.ge_vat)),
