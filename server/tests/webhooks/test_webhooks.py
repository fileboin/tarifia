...
from tarifia.models.subscription import Subscription
...
from tarifia.models.webhook_event import WebhookEvent
from tarifia.webhook.repository import WebhookDeliveryRepository
from tarifia.webhook.service import webhook as webhook_service
from tarifia.webhook.tasks import _webhook_event_send, webhook_event_send
from tests.fixtures.database import SaveFixture


@pytest.fixture
def enqueue_job_mock(mocker: MockerFixture) -> MagicMock:
    return mocker.patch("tarifia.webhook.service.enqueue_job")
