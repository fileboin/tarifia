...
from tarifia.webhook.eventstream import publish_webhook_event


@pytest.fixture
def publish_mock(mocker: MockerFixture) -> MagicMock:
    return mocker.patch("tarifia.webhook.eventstream.publish")
...
class TestPublishWebhookEvent:
    ...
    async def test_publishes_when_listener_active(
        ...
        from tarifia.cli.listener import mark_active
    ...
    async def test_skips_after_listener_disconnects(
        ...
        from tarifia.cli.listener import mark_active, mark_inactive
