...
from tarifia.integrations.stripe.tasks import payment_intent_succeeded
...
class TestPaymentIntentSucceeded:
    async def test_retry_payment_saves_payment_method_and_updates_subscription(
        ...
        context_mock = mocker.patch(
            "tarifia.integrations.stripe.tasks.external_event_service.handle_stripe"
        )
        ...
        mocker.patch(
            "tarifia.integrations.stripe.service.stripe.get_payment_method",
    ...
    async def test_retry_payment_one_time_product_does_not_save_payment_method(
        ...
        subscription_service_mock = mocker.patch(
            "tarifia.integrations.stripe.tasks.subscription_service.update_payment_method_from_retry"
        )
    ...
    async def test_payment_intent_without_order_metadata_ignored(
        ...
        payment_method_service_mock = mocker.patch(
            "tarifia.integrations.stripe.tasks.payment_method_service.upsert_from_stripe_payment_intent_for_order"
        )
