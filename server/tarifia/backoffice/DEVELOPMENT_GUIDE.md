...
This guide covers everything you need to know to create and maintain backoffice pages for the Tarifia billing platform.
...
```bash
mkdir tarifia/backoffice/my_entity
touch tarifia/backoffice/my_entity/__init__.py
touch tarifia/backoffice/my_entity/endpoints.py
touch tarifia/backoffice/my_entity/forms.py  # Optional
```
...
from tarifia.models import MyEntity
from tarifia.my_entity.repository import MyEntityRepository
from tarifia.my_entity.sorting import MyEntitySortProperty
