...
from tarifia.backoffice.responses import HXRedirectResponse
from tarifia.backoffice.toast import add_toast
from tarifia.backoffice.components import datatable, description_list, modal, accordion
```
...
```python
from tarifia.backoffice.components.modal import modal_trigger, modal_content
...
```python
from tarifia.backoffice.components.accordion import accordion, accordion_item
...
```python
from tarifia.backoffice.components import datatable
...
```python
from tarifia.backoffice.components.description_list import description_list, dl_item
...
from tarifia.backoffice.components.input import text_input, select_input, textarea_input
...
- Organizations backoffice: `tarifia/backoffice/organizations_v2/`
- Customers backoffice: `tarifia/backoffice/customers/`
- Components: `tarifia/backoffice/components/`
- Base templates: `tarifia/backoffice/templates/`
