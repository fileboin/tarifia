...
from tarifia.observability.http_metrics import exclude_app_from_metrics
...
from .exception_handlers import backoffice_tarifia_exception_handler
...
app.add_exception_handler(TarifiaError, backoffice_tarifia_exception_handler)
