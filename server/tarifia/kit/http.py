...
async def check_url_reachable(
    ...
    try:
        async with httpx.AsyncClient(
            ...
            timeout=timeout,
            headers={"User-Agent": settings.TARIFIA_USER_AGENT},
...
(see `tarifia.models.checkout.Checkout.success_url`).
...
def get_safe_return_url(return_to: str | None) -> str:
    ...
    if not url_info.netloc:
        ...
        # "https://tarifia.sh@evil.com", which browsers interpret as navigating
