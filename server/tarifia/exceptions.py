...
class TarifiaError(Exception):
    """
    Base exception class for all errors raised by Tarifia.
...
class TarifiaTaskError(TarifiaError):
    """
...
class TarifiaRedirectionError(TarifiaError):
    """
...
class InternalServerError(TarifiaError):
    def __init__(
...
class ResourceNotFound(TarifiaError):
...
class TarifiaRequestValidationError(TarifiaError):
