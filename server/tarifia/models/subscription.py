...
from tarifia.enums import SubscriptionRecurringInterval, TaxBehavior
...
from tarifia.product.guard import is_metered_price
...
class Subscription(CustomFieldDataMixin, MetadataMixin, RecordModel):
    ...
    but has been migrated to be managed by Tarifia.
    """
