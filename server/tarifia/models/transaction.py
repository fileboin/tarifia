...
class TransactionType(StrEnum):
    ...
    payment = "payment"
    """Tarifia received a payment."""
    processor_fee = "processor_fee"
    """A payment processor fee was charged to Tarifia."""
    refund = "refund"
    """Tarifia refunded a payment (totally or partially)."""
    refund_reversal = "refund_reversal"
    """A Tarifia refund is reversed (totally or partially)."""
    dispute = "dispute"
    """A Tarifia payment is disputed (totally or partially)."""
    dispute_reversal = "dispute_reversal"
    """A Tarifia payment dispute is reversed (totally or partially)."""
    balance = "balance"
    """Money flow between Tarifia and a user's account."""
    payout = "payout"
    """Money paid to the user's bank account."""
    payout_reversal = "payout_reversal"
    """A payout is reversed back to Tarifia (totally or partially)."""
...
class ProcessorFeeType(StrEnum):
    ...
    """
    Fee applied when money is transferred to a different country than Tarifia's.
...
class PlatformFeeType(StrEnum):
    """
    Type of fees applied by Tarifia, and billed to the users.
    """
    ...
    to a different country than Tarifia's.
    """
...
class Transaction(RecordModel):
    """
    Represent a money flow in the Tarifia system.
    """
    ...
    """Currency of this transaction from Tarifia's perspective. Should be `usd`."""
    amount: Mapped[int] = mapped_column(BigInteger, nullable=False)
    """Amount in cents of this transaction from Tarifia's perspective."""
    ...
    """Amount of tax in the presentment currency collected by Tarifia for this payment."""
    ...
    """Amount of tax filed to the jurisdiction by Tarifia for this payment."""
    tax_filing_currency: Mapped[str | None] = mapped_column(String(3), nullable=True)
    """Currency in which the tax was filed to the jurisdiction by Tarifia."""
    ...
    If `None`, this transaction concerns Tarifia directly.
    """
