...
class PledgeState(StrEnum):
    # Initiated by customer. Tarifia has not received money yet.
    initiated = "initiated"

    # The pledge has been created.
    # Type=pay_upfront: tarifia has recevied the money
    # Type=pay_on_completion: tarifia has not recevied the money
    created = "created"
    ...
    #
    # Type=pay_upfront: tarifia has recevied the money
    # Type=pay_on_completion: tarifia has recevied the money
    pending = "pending"

    # The pledge was refunded in full before being paid out.
    refunded = "refunded"
    # The pledge was disputed by the customer (via Tarifia)
    disputed = "disputed"
    # The charge was disputed by the customer (via Stripe, aka "chargeback")
    charge_disputed = "charge_disputed"
    # Manually cancalled by a Tarifia admin.
    cancelled = "cancelled"
...
class PledgeType(StrEnum):
    # Up front pledges, paid to Tarifia directly, transfered to maintainer when completed.
