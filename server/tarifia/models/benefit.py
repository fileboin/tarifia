...
if TYPE_CHECKING:
    from tarifia.benefit.strategies import BenefitProperties
    from tarifia.models import BenefitGrant, Organization


class TaxApplicationMustBeSpecified(TarifiaError):
