...
class Payout(RecordModel):
    ...
    Automatically kept in sync by a trigger defined in server/tarifia/models/payout_attempt.py
    """
    ...
    """Fees amount in cents of this transaction from Tarifia's perspective."""
