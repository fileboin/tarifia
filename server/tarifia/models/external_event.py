...
from tarifia.kit.db.models.base import RecordModel
...
class TarifiaSelfEvent(ExternalEvent):
    source: Mapped[Literal[ExternalEventSource.tarifia]] = mapped_column(  # pyright: ignore
        use_existing_column=True, default=ExternalEventSource.tarifia
    )

    __mapper_args__ = {
        "polymorphic_identity": ExternalEventSource.tarifia,
        "polymorphic_load": "inline",
    }
