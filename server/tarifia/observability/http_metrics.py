...
Metrics:
- tarifia_http_request_total: Counter of total requests by endpoint, method, status_code
- tarifia_http_request_duration_seconds: Histogram of request duration by endpoint, method
"""
...
HTTP_REQUEST_DURATION_SECONDS = Histogram(
    "tarifia_http_request_duration_seconds",
...
HTTP_SSE_CONNECTIONS_OPENED = Gauge(
    "tarifia_http_sse_opened_connection_total",
