...
from tarifia.kit.repository.base import RepositoryBase
from tarifia.models import ProcessorTransaction
from tarifia.models.processor_transaction import Processor
