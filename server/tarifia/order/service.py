...
from tarifia.checkout.eventstream import CheckoutEvent, publish_checkout_event
...
from tarifia.customer_portal.schemas.order import (
...
from tarifia.kit.metadata import MetadataQuery, apply_metadata_clause
...
from tarifia.payment_method.service import payment_method as payment_method_service
...
from tarifia.wallet.repository import WalletTransactionRepository
...
class OffSessionChargesNotEnabled(OrderError):
    ...
    def __init__(self, organization_id: uuid.UUID) -> None:
        ...
        super().__init__(
            ...
            f"({organization_id}). Contact Tarifia support to opt in.",
            403,
        )
...
class OrderService:
    ...
    async def _mark_intent_as_failed_sync(self, error: stripe_lib.StripeError) -> None:
        ...
        if payment_intent is not None:
            ...
            intent_metadata["tarifia_failed_sync_payment"] = "true"
