...
from tarifia.exceptions import TarifiaRedirectionError
from tarifia.kit.db.postgres import AsyncSession
from tarifia.kit.http import ReturnTo, get_safe_return_url
...
async def verify_email_update(
    ...
    try:
        ...
        raise TarifiaRedirectionError(e.message, return_to=return_to) from e
