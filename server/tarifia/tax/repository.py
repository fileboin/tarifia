...
from tarifia.models import Order, Transaction
...
# `tax_amount` across these types yields the net tax Tarifia remitted. Other
...
class TaxJurisdictionRepository(RepositoryBase[Transaction]):
    ...
    def get_jurisdictions_statement(
        ...
        *,
        ...
        # which yields the net tax Tarifia remitted on the merchant's behalf after
