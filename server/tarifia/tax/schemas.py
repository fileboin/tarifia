...
class TaxJurisdiction(Schema):
    """Aggregated tax remitted by Tarifia for a single jurisdiction.
    ...
    tax_amount: int = Field(
        description=(
            "Net tax remitted by Tarifia in this jurisdiction, in the currency's "
...
class TaxSummary(Schema):
    """Aggregated tax remitted by Tarifia across all jurisdictions.
    ...
    tax_amount: int = Field(
        description=(
            "Net tax remitted by Tarifia across all jurisdictions, in the "
