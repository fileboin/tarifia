...
from tarifia.models import Customer, PaymentMethod
from tarifia.openapi import APITag
from tarifia.organization.schemas import OrganizationID
from tarifia.payment_method.schemas import PaymentMethodTypeAdapter
...
@router.get("/export", summary="Export Customers", response_class=CSVStreamingResponse)
async def export(
    auth_subject: auth.CustomerRead,
    organization_id: MultipleQueryFilter[OrganizationID] | None = Query(
    ...
    return CSVStreamingResponse(create_csv(), "tarifia-customers.csv")
