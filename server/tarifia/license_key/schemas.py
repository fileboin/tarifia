...
from tarifia.benefit.schemas import BenefitID
...
from tarifia.exceptions import NotPermitted, ResourceNotFound, Unauthorized
...
from tarifia.kit.schemas import IDSchema, Int32, Schema, TimestampedSchema
...
class LicenseKeyValidate(Schema):
    ...
    increment_usage: int | None = Field(default=None, ge=0)
