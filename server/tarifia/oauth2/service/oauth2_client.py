...
from tarifia.email.schemas import OAuth2LeakedClientEmail, OAuth2LeakedClientProps
...
from tarifia.models import OAuth2Client, User
    ...
    async def revoke_leaked(
        ...
        *,
        ...
        if token_type == TokenType.client_secret:
            ...
            subject = (
                "Security Notice - Your Tarifia OAuth2 Client Secret has been leaked"
            )
        elif token_type == TokenType.client_registration_token:
            ...
            subject = (
                "Security Notice - "
                "Your Tarifia OAuth2 Client Registration Token has been leaked"
            )
        session.add(client)
