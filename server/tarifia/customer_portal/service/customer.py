...
from tarifia.models import Customer as CustomerModel
from tarifia.models import PaymentMethod
...
class CustomerError(TarifiaError): ...
    ...
    async def add_payment_method(
        ...
        try:
            ...
            return_url = add_query_parameters(
                ...
                tarifia_setup_intent=setup_intent.id,
            )
