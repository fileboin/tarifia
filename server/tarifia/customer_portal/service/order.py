...
from tarifia.models import Order, Product
from tarifia.models.product import ProductBillingType
from tarifia.order.service import InvoiceDoesNotExist, ReceiptNotAllocated
...
class CustomerOrderError(TarifiaError): ...
