...
from tarifia.customer.service import customer as main_customer_service
from tarifia.eventstream.endpoints import subscribe
from tarifia.eventstream.service import Receivers
from tarifia.exceptions import ResourceNotFound
from tarifia.kit.http import get_content_disposition
...
from tarifia.payment_method.service import PaymentMethodInUseByActiveSubscription
...
async def export(
    ...
    filename = f"tarifia-customer-export-{customer.id}.json"
    return Response(
