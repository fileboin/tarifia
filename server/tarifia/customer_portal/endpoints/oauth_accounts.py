...
from tarifia.auth.models import Customer, Member, is_anonymous, is_customer, is_member
...
from tarifia.kit.http import ReturnTo, add_query_parameters, get_safe_return_url
from tarifia.member.repository import MemberRepository
from tarifia.member_session.service import member_session as member_session_service
from tarifia.models.benefit import BenefitType
from tarifia.models.customer import CustomerOAuthAccount, CustomerOAuthPlatform
...
class OAuthCallbackError(TarifiaError):
