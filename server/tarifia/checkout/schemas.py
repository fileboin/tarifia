...
from tarifia.custom_field.data import (
    CustomFieldDataInputMixin,
    CustomFieldDataOutputMixin,
)
from tarifia.custom_field.schemas import AttachedCustomField
from tarifia.customer.schemas.customer import CustomerNameInput
...
from tarifia.kit.address import Address, AddressInput
from tarifia.kit.currency import PresentmentCurrency
from tarifia.kit.email import EmailStrDNS
from tarifia.kit.http import SuccessUrl
from tarifia.kit.locale import Locale
...
from tarifia.organization.schemas import OrganizationPublicBase
...
EmbedOrigin = Annotated[
    ...
    Field(
        description=(
            ...
            "It'll allow the Tarifia iframe to communicate with the parent page."
        ),
    ),
]
...
_external_customer_id_description = (
    ...
    "If a matching customer exists on Tarifia, the resulting order "
