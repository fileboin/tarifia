...
from tarifia.webhook.repository import WebhookDeliveryRepository, WebhookEventRepository
...
async def _webhook_event_send(
    ...
    headers: Mapping[str, str] = {
        "user-agent": "tarifia.sh webhooks",
...
async def _webhook_event_publish(
    ...
    from tarifia.webhook.eventstream import WebhookEvent
