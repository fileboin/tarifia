...
from tarifia.benefit.schemas import Benefit as BenefitSchema
from tarifia.benefit.schemas import BenefitGrantWebhook
from tarifia.checkout.schemas import Checkout as CheckoutSchema
from tarifia.customer.schemas.customer import CustomerResponse as CustomerSchema
from tarifia.customer.schemas.state import CustomerState as CustomerStateSchema
from tarifia.customer_seat.schemas import CustomerSeat as CustomerSeatSchema
from tarifia.exceptions import TarifiaError
from tarifia.integrations.discord.webhook import (
    DiscordEmbedField,
    DiscordPayload,
    get_branded_discord_embed,
)
from tarifia.kit.schemas import IDSchema, Schema
from tarifia.member.schemas import Member as MemberSchema
...
from tarifia.order.schemas import Order as OrderSchema
from tarifia.organization.schemas import Organization as OrganizationSchema
from tarifia.product.schemas import Product as ProductSchema
from tarifia.refund.schemas import Refund as RefundSchema
from tarifia.subscription.schemas import Subscription as SubscriptionSchema
...
class UnsupportedTarget(TarifiaError):
    def __init__(
        self,
