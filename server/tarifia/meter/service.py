...
from tarifia.meter.aggregation import AggregationFunction
...
from tarifia.subscription.repository import (
...
class MeterService:
    ...
    async def create_billing_entries(
        ...
        async for event in event_repository.stream(statement):
            ...
            # Tarifia never charges during a trial: skip trial events so no
