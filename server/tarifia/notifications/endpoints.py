...
from tarifia.notification_recipient import (
    auth as notification_recipient_auth,
)
from tarifia.notification_recipient.schemas import (
    NotificationRecipientCreate,
    NotificationRecipientPlatform,
    NotificationRecipientSchema,
)
from tarifia.notification_recipient.service import (
    notification_recipient as notification_recipient_service,
)
from tarifia.notifications import (
