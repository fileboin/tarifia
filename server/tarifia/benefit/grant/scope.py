...
from tarifia.models.benefit_grant import BenefitGrantScope, BenefitGrantScopeArgs
from tarifia.models.order import Order
...
class BenefitGrantScopeError(TarifiaError): ...
