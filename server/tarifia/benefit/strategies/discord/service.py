...
from tarifia.integrations.discord.service import discord_bot as discord_bot_service
                ...
                [
                    {
                        ...
                        "msg": "This role is above the Tarifia bot role, so Discord won't let our bot grants it. Please reorder them so the Tarifia bot is above.",
                        "loc": ("role_id",),
                        "input": role_id,
                    }
                ]
