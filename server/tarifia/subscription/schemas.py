...
from tarifia.custom_field.data import CustomFieldDataOutputMixin
...
from tarifia.meter.schemas import Meter
from tarifia.models.subscription import CustomerCancellationReason, SubscriptionStatus
from tarifia.product.schemas import Product, ProductPrice
...
class SubscriptionCreateExternalCustomer(SubscriptionCreateBase):
    ...
    external_customer_id: str = Field(
        description=(
            ...
            "It must already exist in Tarifia."
        )
    )
