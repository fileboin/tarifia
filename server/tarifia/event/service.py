...
from tarifia.auth.models import AuthSubject, is_organization, is_user
...
from tarifia.kit.metadata import MetadataQuery
...
from tarifia.meter.aggregation import PropertyAggregation
from tarifia.meter.filter import Filter
from tarifia.meter.repository import MeterRepository
...
from tarifia.worker import enqueue_events, enqueue_job
...
class EventService:
    ...
    async def list_customer_stats(
        ...
        *,
        ...
        # Fetch customer details for all rows that have a Tarifia customer_id,
        # or an external_customer_id that maps to a readable Tarifia customer.
        row_customer_ids = [
