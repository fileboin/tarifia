...
from tarifia.benefit.schemas import Benefit
...
from tarifia.order.schemas import OrderBase, OrderItemSchema
from tarifia.organization.schemas import Organization
from tarifia.product.schemas import BenefitList, ProductBase
from tarifia.subscription.schemas import SubscriptionBase
...
class EmailTemplate(StrEnum):
    ...
    tarifia_self_subscription_confirmation = "tarifia_self_subscription_confirmation"
    tarifia_self_subscription_cycled = "tarifia_self_subscription_cycled"
    tarifia_self_startup_program_welcome = "tarifia_self_startup_program_welcome"
...
class TarifiaSelfSubscriptionConfirmationProps(EmailProps):
    product_name: str


class TarifiaSelfSubscriptionConfirmationEmail(BaseModel):
    template: Literal[EmailTemplate.tarifia_self_subscription_confirmation] = (
        EmailTemplate.tarifia_self_subscription_confirmation
    )
    props: TarifiaSelfSubscriptionConfirmationProps


class TarifiaSelfSubscriptionCycledProps(EmailProps):
    product_name: str


class TarifiaSelfSubscriptionCycledEmail(BaseModel):
    template: Literal[EmailTemplate.tarifia_self_subscription_cycled] = (
        EmailTemplate.tarifia_self_subscription_cycled
    )
    props: TarifiaSelfSubscriptionCycledProps


class TarifiaSelfStartupProgramWelcomeProps(EmailProps):
    organization_name: str
    billing_url: str


class TarifiaSelfStartupProgramWelcomeEmail(BaseModel):
    template: Literal[EmailTemplate.tarifia_self_startup_program_welcome] = (
        EmailTemplate.tarifia_self_startup_program_welcome
    )
    props: TarifiaSelfStartupProgramWelcomeProps
