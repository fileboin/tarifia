...
from tarifia.kit.http import is_localhost
from tarifia.models import AuthenticationSession
...
TOKEN_PREFIX = "tarifia_auth_session_"


class AuthenticationSessionException(TarifiaError): ...
