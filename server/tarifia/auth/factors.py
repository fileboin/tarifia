...
from tarifia.email.schemas import LoginCodeEmail, LoginCodeProps
...
from tarifia.models import BackupCodesEnrollment, EmailOTP, TOTPEnrollment
...
class EmailOTPFactor(EmailOTPFactorBase):
    ...
    async def request(
        ...
        subject = "Sign up to Tarifia" if signup else "Sign in to Tarifia"
