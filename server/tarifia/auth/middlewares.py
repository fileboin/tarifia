...
from tarifia.personal_access_token.service import (
...
from tarifia.rate_limit import clear_cached_identity, write_cached_identity
from tarifia.redis import Redis
from tarifia.sentry import set_sentry_user
...
async def get_auth_subject(
    ...
    if token is not None:
        ...
        # Try MemberSession first (tarifia_mst_ prefix)
