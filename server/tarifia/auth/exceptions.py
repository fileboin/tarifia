...
class TarifiaAuthError(TarifiaError):
    """
...
class UnavailableFactorError(TarifiaAuthError):
    """
...
class GetEmailError(TarifiaAuthError):
    """
...
class TarifiaAuthRedirectionError(TarifiaError):
    """
