...
from tarifia.auth.dependencies import _Authenticator
...
class DocumentedAuthSubjectAPIRoute(APIRoute):
    ...
    def __init__(
        ...
        if "x-tarifia-allowed-subjects" not in openapi_extra:
            for param in typing.get_type_hints(endpoint, include_extras=True).values():
                ...
                kwargs["openapi_extra"] = {
                    "x-tarifia-allowed-subjects": allowed_subjects_names,
                    **openapi_extra,
                }
