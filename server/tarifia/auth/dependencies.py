...
from tarifia.exceptions import NotPermitted, Unauthorized
...
pat_scheme = HTTPBearer(
    scheme_name="pat",
    auto_error=False,
    description="You can generate a **Personal Access Token** from your [settings](https://tarifia.sh/settings).",
)
