...
from tarifia.invoice.seller import get_tarifia_additional_info
...
from tarifia.tax.calculation.base import TaxabilityReason, TaxBreakdownItem
...
class Invoice(BaseModel):
    ...
    def from_order(cls, order: "Order") -> Self:
        ...
        return cls(
            ...
            seller_additional_info=get_tarifia_additional_info(order.billing_address),
