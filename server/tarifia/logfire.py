...
from tarifia.observability.s3_span_exporter import S3SpanExporter
...
from tarifia.kit.db.postgres import Engine
from tarifia.observability.otel_prometheus import PrometheusMeterProvider
...
def configure_logfire(service_name: Literal["server", "worker"]) -> None:
    ...
    logfire.configure(
        ...
        code_source=logfire.CodeSource(
            repository="https://github.com/tarifiasource/tarifia",
