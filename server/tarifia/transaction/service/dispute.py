...
from tarifia.event.system import BalanceDisputeMetadata, SystemEvent, build_system_event
...
from tarifia.models import Customer, Dispute, Transaction
...
class DisputeTransactionService(BaseTransactionService):
    async def create_dispute(
        ...
        if dispute.payment_processor == PaymentProcessor.stripe:
            ...
            settlement_tax_amount = -tarifia_round(dispute.tax_amount * exchange_rate)
        else:
