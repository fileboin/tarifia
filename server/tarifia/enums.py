...
class TokenType(StrEnum):
    client_secret = "tarifia_client_secret"
    client_registration_token = "tarifia_client_registration_token"
    authorization_code = "tarifia_authorization_code"
    access_token = "tarifia_access_token"
    refresh_token = "tarifia_refresh_token"
    personal_access_token = "tarifia_personal_access_token"
    organization_access_token = "tarifia_organization_access_token"
    customer_session_token = "tarifia_customer_session_token"
    user_session_token = "tarifia_user_session_token"
