...
from tarifia.models.organization import Organization as OrgModel
...
class MemberService:
    ...
    async def delete(
        ...
        Raises:
            TarifiaRequestValidationError: If trying to delete the only owner
        """
        repository = MemberRepository.from_session(session)
    ...
    async def delete_by_customer(
        ...
        """
        from tarifia.benefit.grant.service import (
