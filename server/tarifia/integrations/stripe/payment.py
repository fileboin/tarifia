...
from tarifia.models.payment import DUNNING_COUNTING_TRIGGERS, PaymentTrigger
...
from tarifia.wallet.repository import WalletRepository, WalletTransactionRepository

log: Logger = structlog.get_logger()


class OrderDoesNotExist(TarifiaError):
...
class OutdatedCheckoutIntent(TarifiaError):
    """
...
class UnresolvedPaymentError(TarifiaError):
        ...
        if order is None:
            ...
            if payment_intent_id is not None:
                ...
                if (
                    ...
                    and updated_intent.metadata.get("tarifia_failed_sync_payment")
                    == "true"
                ):
                    return None
        ...
        if object.OBJECT_NAME == "setup_intent":
            ...
            if checkout.status == CheckoutStatus.open:
                ...
                if (
                    ...
                    and updated_object.metadata.get("tarifia_trial_abuse_detected")
                    == "true"
                ):
                    raise OutdatedCheckoutIntent(checkout.id, object.id)
