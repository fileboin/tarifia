...
from tarifia.exceptions import BadRequest, ResourceNotFound, Unauthorized
from tarifia.kit.db.postgres import AsyncReadSession as AsyncReadSessionT
from tarifia.kit.db.postgres import AsyncSession as AsyncSessionT
...
async def list_integrations(
    ...
    await _assert_slack_benefit_enabled(session, organization_id)
