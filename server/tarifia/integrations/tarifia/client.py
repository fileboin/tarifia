...
import httpx
import logfire
from tarifia_sdk import Tarifia as TarifiaSDK
...
from tarifia_sdk.models.membercreate import Role as MemberCreateRole
from tarifia_sdk.models.tarifiaerror import TarifiaError

from tarifia.config import settings
from tarifia.exceptions import TarifiaError as InternalTarifiaError

from .exceptions import (
    TarifiaSelfBenefitGrantNotFound,
    TarifiaSelfNotPaidOrder,
    TarifiaSelfPaymentMethodInUse,
    TarifiaSelfPaymentMethodNotFound,
)


class TarifiaSelfClientError(InternalTarifiaError):
    def __init__(self, message: str) -> None:
        super().__init__(message)


class TarifiaSelfClientOperationalError(TarifiaSelfClientError):
    """Raised for transient/retryable SDK errors (429, 5xx, network)."""


class TarifiaSelfClientValidationError(InternalTarifiaError):
...
def _raise_error(span: Any, error: Any, operation: str) -> NoReturn:
    ...
    if error.status_code == 429 or error.status_code >= 500:
        raise TarifiaSelfClientOperationalError(message) from error
    raise TarifiaSelfClientError(message) from error
...
class TarifiaSelfClient:
    ...
    async def create_customer(
        ...
        *,
        ...
        with logfire.span("tarifia.create_customer", external_id=external_id) as span:
            try:
    ...
    async def get_order(self, *, order_id: str) -> Order | None:
        with logfire.span("tarifia.get_order", order_id=order_id) as span:
            try:
    ...
    async def get_order_invoice(self, *, order_id: str) -> str | None:
        with logfire.span("tarifia.get_order_invoice", order_id=order_id) as span:
            try:
    ...
    async def trigger_order_invoice_generation(self, *, order_id: str) -> None:
        ...
        Raises ``TarifiaSelfNotPaidOrder`` if the API returns 422 — the order's
        payment hasn't settled yet, and the caller should retry later.
        """
        with logfire.span(
            "tarifia.trigger_order_invoice_generation", order_id=order_id
        ) as span:
            try:
                ...
                if e.status_code == 422:
                    ...
                    raise TarifiaSelfNotPaidOrder(order_id) from e
    ...
    async def list_recurring_products(self, *, organization_id: str) -> list[Product]:
        with logfire.span(
            "tarifia.list_recurring_products", organization_id=organization_id
        ) as span:
    ...
    async def get_active_subscription(
        ...
        with logfire.span(
            "tarifia.get_active_subscription",
    ...
    async def update_subscription_product(
        ...
        *,
        ...
        with logfire.span(
            "tarifia.update_subscription_product",
            subscription_id=subscription_id,
            product_id=product_id,
        ) as span:
            try:
    ...
    async def update_subscription_discount(
        ...
        """
        with logfire.span(
            "tarifia.update_subscription_discount",
            subscription_id=subscription_id,
            discount_id=discount_id,
        ) as span:
            try:
    ...
    async def list_billing_contacts(self, *, customer_id: str) -> list[Member]:
        ...
        with logfire.span(
            "tarifia.list_billing_contacts", customer_id=customer_id
        ) as span:
    ...
    async def update_customer_metadata(
        ...
        # The Tarifia API replaces metadata wholesale on update; callers must
        # merge any existing keys they want to preserve before passing them in.
        with logfire.span(
            "tarifia.update_customer_metadata", external_id=external_id
        ) as span:
            try:
    ...
    async def create_percentage_discount(
        ...
        *,
        ...
        with logfire.span(
            "tarifia.create_percentage_discount",
            name=name,
    ...
    async def get_discount(self, *, discount_id: str) -> Discount | None:
        with logfire.span("tarifia.get_discount", discount_id=discount_id) as span:
            try:
    ...
    async def delete_discount(self, *, discount_id: str) -> None:
        ...
        with logfire.span("tarifia.delete_discount", discount_id=discount_id) as span:
            try:
    ...
    async def list_customer_benefit_grants(
        ...
        with logfire.span(
            "tarifia.list_customer_benefit_grants", customer_id=customer_id
        ) as span:
    ...
    async def delete_customer(self, *, external_id: str) -> None:
        with logfire.span("tarifia.delete_customer", external_id=external_id) as span:
            try:
    ...
    async def track_organization_review_usage(
        ...
        *,
        ...
        with logfire.span(
            "tarifia.track_organization_review_usage",
            external_customer_id=external_customer_id,
        ...
        *,
        ...
        with logfire.span(
            ...
            try:
                ...
                _raise_error(span, e, "tarifia.portal.get_customer")
            except httpx.RequestError as e:
                _raise_network_error(span, e, "tarifia.portal.get_customer")
    ...
    async def portal_list_payment_methods(
        ...
        *,
        ...
        with logfire.span(
            "tarifia.portal.list_payment_methods",
            external_customer_id=external_customer_id,
            external_member_id=external_member_id,
        ) as span:
            ...
            try:
                ...
                _raise_error(span, e, "tarifia.portal.list_payment_methods")
            except httpx.RequestError as e:
                _raise_network_error(span, e, "tarifia.portal.list_payment_methods")
    ...
    async def portal_delete_payment_method(
        ...
        *,
        ...
        with logfire.span(
            "tarifia.portal.delete_payment_method",
            external_customer_id=external_customer_id,
            external_member_id=external_member_id,
            ...
            try:
                ...
                if e.status_code == 404:
                    span.set_attribute("not_found", True)
                    raise TarifiaSelfPaymentMethodNotFound(payment_method_id) from e
                if e.status_code == 400:
                    span.set_attribute("http.status_code", 400)
                    span.set_attribute("error.body", str(e.body))
                    raise TarifiaSelfPaymentMethodInUse(payment_method_id) from e
                _raise_error(span, e, "tarifia.portal.delete_payment_method")
            except httpx.RequestError as e:
                _raise_network_error(span, e, "tarifia.portal.delete_payment_method")
    ...
    async def portal_create_customer_session(
        ...
        *,
        ...
        Tarifia billing customer."""
        with logfire.span(
            "tarifia.portal.create_customer_session",
            external_customer_id=external_customer_id,
            external_member_id=external_member_id,
        ) as span:
            try:
                ...
                _raise_error(span, e, "tarifia.portal.create_customer_session")
            except httpx.RequestError as e:
                _raise_network_error(span, e, "tarifia.portal.create_customer_session")
    ...
    async def portal_update_customer(
        ...
        *,
        ...
        with logfire.span(
            "tarifia.portal.update_customer",
            external_customer_id=external_customer_id,
            external_member_id=external_member_id,
        ) as span:
            try:
                ...
                if e.status_code == 422:
                    ...
                    span.set_attribute("error.body", str(e.body))
                    raise TarifiaSelfClientValidationError(e.body) from e
                _raise_error(span, e, "tarifia.portal.update_customer")
            except httpx.RequestError as e:
                _raise_network_error(span, e, "tarifia.portal.update_customer")
    ...
    async def portal_list_benefit_grants(
        ...
        *,
        ...
        with logfire.span(
            "tarifia.portal.list_benefit_grants",
            external_customer_id=external_customer_id,
            external_member_id=external_member_id,
        ) as span:
            ...
            try:
                ...
                _raise_error(span, e, "tarifia.portal.list_benefit_grants")
            except httpx.RequestError as e:
                _raise_network_error(span, e, "tarifia.portal.list_benefit_grants")
    ...
    async def portal_update_benefit_grant(
        ...
        *,
        ...
        with logfire.span(
            "tarifia.portal.update_benefit_grant",
            external_customer_id=external_customer_id,
            external_member_id=external_member_id,
            ...
            try:
                ...
                if e.status_code == 404:
                    span.set_attribute("not_found", True)
                    raise TarifiaSelfBenefitGrantNotFound(benefit_grant_id) from e
                if e.status_code == 422:
                    span.set_attribute("http.status_code", 422)
                    span.set_attribute("error.body", str(e.body))
                    raise TarifiaSelfClientValidationError(e.body) from e
                _raise_error(span, e, "tarifia.portal.update_benefit_grant")
            except httpx.RequestError as e:
                _raise_network_error(span, e, "tarifia.portal.update_benefit_grant")


_client: TarifiaSelfClient | None = None


def get_client() -> TarifiaSelfClient:
    global _client
    if _client is None:
        _client = TarifiaSelfClient(
            access_token=settings.TARIFIA_ACCESS_TOKEN,
            api_url=settings.TARIFIA_API_URL,
        )
    return _client
