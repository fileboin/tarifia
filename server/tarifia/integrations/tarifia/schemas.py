...
class OrganizationPlan(Schema):
    product_id: str | None = Field(
        default=None,
        description=(
            "Tarifia product ID. Null for the synthesized free plan, which has no "
            "underlying Tarifia product."
        ),
    )
    name: str
...
class OrganizationSubscription(Schema):
    subscription_id: str | None = Field(
        default=None,
        description=(
            "Tarifia subscription ID. Null when the organization has no active "
    ...
    startup_program_status: str | None = Field(
        default=None,
        description=(
            "Tarifia Startup Program status for this organization. Derived from "
    ...
    startup_program_scale_product_id: str | None = Field(
        default=None,
        description=(
            "Tarifia product id of the Scale plan, against which the Startup "
...
class OrganizationCheckoutRequest(Schema):
    product_id: str = Field(description="Tarifia product ID to subscribe to.")
...
class OrganizationSubscriptionUpdate(Schema):
    product_id: str = Field(description="Tarifia product ID to switch the plan to.")
...
class OrganizationCustomerSession(Schema):
    token: str = Field(
        description=(
            ...
            "mirrored Tarifia billing customer. Authenticates against "
