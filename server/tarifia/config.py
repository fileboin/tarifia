...
from tarifia.enums import EmailSender, TaxProcessor
from tarifia.kit.address import Address, CountryAlpha2
from tarifia.kit.jwk import JWKSFile
...
env = Environment(os.getenv("TARIFIA_ENV", Environment.development))
...
class Settings(BaseSettings):
    ...
    CURRENT_JWK_KID: str = "tarifia_dev"
    WWW_AUTHENTICATE_REALM: str = "tarifia"
    ...
    # User-Agent sent by Tarifia's outbound HTTP clients (e.g. URL reachability
    # checks). Excludes the org review website/setup collectors, which use a
    # browser-like UA to avoid bot detection by CDNs.
    TARIFIA_USER_AGENT: str = "Tarifia/1.0 (+https://tarifia.sh)"
    ...
    CHECKOUT_LINK_HOST: str | None = None  # e.g., "buy.tarifia.sh" in production
    ...
    AUTHENTICATION_SESSION_COOKIE_KEY: str = "tarifia_auth_session"
    ...
    OAUTH2_SESSION_STATE_COOKIE_KEY: str = "tarifia_oauth2_state"
    OAUTH2_SESSION_STATE_COOKIE_DOMAIN: str = "127.0.0.1"

    # User session
    USER_SESSION_TTL: timedelta = timedelta(days=31)
    USER_SESSION_COOKIE_KEY: str = "tarifia_session"
    ...
    IMPERSONATION_COOKIE_KEY: str = "tarifia_original_session"
    IMPERSONATION_INDICATOR_COOKIE_KEY: str = "tarifia_is_impersonating"
    ...
    # Database
    POSTGRES_USER: str = "tarifia"
    POSTGRES_PWD: str = "tarifia"
    POSTGRES_HOST: str = "127.0.0.1"
    POSTGRES_PORT: int = 5432
    POSTGRES_DATABASE: str = "tarifia"
    ...
    EMAIL_FROM_NAME: str = "Tarifia"
    EMAIL_FROM_DOMAIN: str = "notifications.tarifia.sh"
    EMAIL_FROM_LOCAL: str = "mail"
    EMAIL_DEFAULT_REPLY_TO_NAME: str = "Tarifia Support"
    EMAIL_DEFAULT_REPLY_TO_EMAIL_ADDRESS: str = "support@tarifia.sh"
    ...
    STRIPE_STATEMENT_DESCRIPTOR: str = "TARIFIA"
    ...
    # Discord
    FAVICON_URL: str = "https://raw.githubusercontent.com/tarifiasource/tarifia/2648cf7472b5128704a097cd1eb3ae5f1dd847e5/docs/docs/assets/favicon.png"
    THUMBNAIL_URL: str = "https://raw.githubusercontent.com/tarifiasource/tarifia/4fd899222e200ca70982f437039f549b7a822ecc/clients/apps/web/public/email-logo-dark.png"
    ...
    # AWS (File Downloads)
    AWS_ACCESS_KEY_ID: str = "tarifia-development"
    AWS_SECRET_ACCESS_KEY: str = "tarifia123456789"
    ...
    WORKER_SQS_QUEUE_PREFIX: str = "tarifia-tasks"
    ...
    # Downloadable files
    S3_FILES_BUCKET_NAME: str = "tarifia-s3"
    S3_FILES_PUBLIC_BUCKET_NAME: str = "tarifia-s3-public"
    ...
    MINIO_USER: str = "tarifia"
    MINIO_PWD: str = "tarifiatarifia"

    # Chargeback Stop
    CHARGEBACK_STOP_WEBHOOK_SECRET: str = ""

    # Tarifia's usage of Tarifia
    TARIFIA_ACCESS_TOKEN: str = ""
    TARIFIA_WEBHOOK_SECRET: str = ""
    TARIFIA_ORGANIZATION_ID: str = ""
    TARIFIA_FREE_PRODUCT_ID: str = ""
    # Scale plan product, used by the Startup Program to grant a 100% discount
    TARIFIA_SCALE_PRODUCT_ID: str = ""
    TARIFIA_API_URL: str = "https://api.tarifia.sh"

    @property
    def TARIFIA_SELF_ENABLED(self) -> bool:
        return all(
            [
                self.TARIFIA_ACCESS_TOKEN,
                self.TARIFIA_ORGANIZATION_ID,
                self.TARIFIA_FREE_PRODUCT_ID,
            ]
        )
    ...
    def STARTUP_PROGRAM_ENABLED(self) -> bool:
        ...
        return bool(
            self.TARIFIA_ORGANIZATION_ID
            and self.TARIFIA_SCALE_PRODUCT_ID
            and self.TARIFIA_ACCESS_TOKEN
        )
    ...
    # Invoices
    S3_CUSTOMER_INVOICES_BUCKET_NAME: str = "tarifia-customer-invoices"
    S3_CUSTOMER_RECEIPTS_BUCKET_NAME: str = "tarifia-customer-receipts"
    S3_PAYOUT_INVOICES_BUCKET_NAME: str = "tarifia-payout-invoices"
    INVOICES_NAME: str = "Tarifia Software, Inc."
    ...
    def frontend_hostname(self) -> str:
        return urlparse(self.FRONTEND_BASE_URL).hostname or "tarifia.sh"
