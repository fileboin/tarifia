...
from tarifia.kit.metadata import add_metadata_query_schema
from tarifia.oauth2.schemas import add_oauth2_form_schemas
        ...
        return [
            {
                "name": cls.public,
                "description": (
                    "Endpoints shown and documented in the Tarifia API documentation "
...
OPENAPI_PARAMETERS: OpenAPIParameters = {
    "title": "Tarifia API",
    "summary": "Tarifia HTTP and Webhooks API",
    "description": "Read the docs at https://tarifia.sh/docs/api-reference",
    "docs_url": None
    ...
    "servers": [
        {
            "url": "https://api.tarifia.sh",
            "description": "Production environment",
            "x-speakeasy-server-id": "production",
        },
        {
            "url": "https://sandbox-api.tarifia.sh",
