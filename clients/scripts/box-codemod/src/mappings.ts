...
const COLOR_PAIRS: Record<string, Record<string, string>> = {
  backgroundColor: {
    'bg-white|dark:bg-tarifia-950': 'background-primary',
    'bg-white|dark:bg-tarifia-900': 'background-primary',
    'bg-gray-50|dark:bg-tarifia-900': 'background-secondary',
    'bg-white|dark:bg-tarifia-800': 'background-card',
  },
  color: {
    'text-gray-900|dark:text-white': 'text-primary',
    'text-gray-500|dark:text-tarifia-400': 'text-secondary',
    'text-gray-400|dark:text-tarifia-500': 'text-tertiary',
  },
  borderColor: {
    'border-gray-200|dark:border-tarifia-700': 'border-primary',
  },
}
