...
const Card = ({
  ...
  <CardPrimitive
    ref={ref}
    className={twMerge(
      'dark:bg-tarifia-800 rounded-4xl border-transparent bg-gray-100 text-gray-950 shadow-none dark:border-transparent dark:text-white',
      className,
    )}
    {...props}
  />
...
const CardDescription = ({
  ...
  <CardDescriptionPrimitive
    ref={ref}
    className={twMerge('dark:text-tarifia-400 text-sm text-gray-400', className)}
    {...props}
  />
)
