...
import { Button } from '@tarifia-sh/orbit/ui/button'
import {
  Command,
  CommandEmpty,
  CommandGroup,
      ...
      <span className={cn('block w-full', disabled && 'cursor-not-allowed')}>
        <PopoverTrigger asChild>
          <Button
            ...
            disabled={disabled}
            className={cn(
              'dark:bg-tarifia-800 dark:hover:bg-tarifia-700 dark:hover:border-tarifia-700 dark:border-tarifia-700 flex w-full flex-row justify-between gap-x-2 rounded-lg border border-gray-200 bg-white px-3 font-normal shadow-xs transition-colors hover:bg-gray-50 hover:text-black dark:hover:text-white',
              className,
            )}
          >
