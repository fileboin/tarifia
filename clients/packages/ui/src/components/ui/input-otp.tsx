...
const InputOTPSlot = ({
  ...
  return (
    <div
      ref={ref}
      className={cn(
        'border-input dark:bg-tarifia-900 relative flex h-10 w-10 items-center justify-center border-y border-r bg-white text-sm transition-all first:rounded-l-md first:border-l last:rounded-r-md',
