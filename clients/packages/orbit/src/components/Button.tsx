  ...
  'relative font-normal inline-flex items-center cursor-pointer font-display font-semibold select-none justify-center rounded-full text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 whitespace-nowrap',
  {
    variants: {
      variant: {
        ...
        outline:
          'text-black dark:text-white hover:bg-gray-200 dark:bg-transparent dark:hover:bg-tarifia-700 border-transparent hover:border-gray-200 border dark:border-tarifia-700 bg-transparent border-gray-100',
        secondary:
          'text-black dark:text-white hover:bg-gray-200 dark:bg-tarifia-700 dark:hover:bg-tarifia-600 bg-gray-100 border dark:border-white/5 border-black/4',
        underline:
        ...
        ghost:
          'bg-transparent hover:bg-gray-200 dark:hover:bg-tarifia-700 dark:bg-transparent text-black dark:text-white',
      },
      size: {
