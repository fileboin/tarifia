...
const TabsTrigger = ({
  ...
  <TabsTriggerPrimitive
    ref={ref}
    className={twMerge(
      'dark:data-[state=active]:bg-tarifia-700 dark:hover:text-tarifia-50 dark:text-tarifia-500 cursor-pointer px-4 text-gray-400 hover:text-black data-[state=active]:rounded-xl data-[state=active]:bg-gray-100 data-[state=active]:text-black data-[state=active]:shadow-none dark:data-[state=active]:text-white',
