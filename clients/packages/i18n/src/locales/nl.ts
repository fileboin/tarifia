export default {
  checkout: {
    footer: {
      ...
      mandateOneTime:
        'Door op "{buttonLabel}" te klikken, machtig je Tarifia Software, Inc., onze online wederverkoper en officiële verkoper, om het hierboven getoonde bedrag via je gekozen betaalmethode in rekening te brengen, en ga je akkoord met de {buyerTermsLink}. Dit is een eenmalige betaling.',
    },
    form: {
      email: 'E-mailadres',
