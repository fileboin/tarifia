export default {
  checkout: {
    footer: {
      ...
      mandateOneTime:
        'Genom att klicka på "{buttonLabel}" godkänner du att Tarifia Software, Inc., vår onlineåterförsäljare och registrerade handlare, debiterar din valda betalningsmetod med beloppet som visas ovan, samt accepterar {buyerTermsLink}. Detta är en engångsavgift.',
    },
    form: {
      email: 'Email',
