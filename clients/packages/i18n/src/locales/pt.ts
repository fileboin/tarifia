export default {
  checkout: {
    footer: {
      ...
      mandateOneTime:
        'Ao clicar em "{buttonLabel}", você autoriza a Tarifia Software, Inc., nossa revendedora online e vendedora oficial, a cobrar o valor mostrado acima na sua forma de pagamento selecionada e concorda com os {buyerTermsLink}. Esta é uma cobrança única.',
    },
    form: {
      email: 'E-mail',
