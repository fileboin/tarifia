export default {
  checkout: {
    footer: {
      ...
      merchantOfRecord:
        'Cette commande est traitée par notre revendeur en ligne et commerçant enregistré, Tarifia, qui gère également les demandes et les retours liés à la commande.',
      mandateSubscriptionTrial:
        "En cliquant sur \"{buttonLabel}\", vous autorisez Tarifia Software, Inc., notre revendeur en ligne et marchand officiel, à débiter votre moyen de paiement sélectionné du montant indiqué ci-dessus à la fin de votre période d'essai et à chaque date de facturation ultérieure jusqu'à votre résiliation, et vous acceptez les {buyerTermsLink}. Vous pouvez annuler à tout moment avant la fin de votre essai pour éviter d'être facturé.",
      mandateSubscription:
      ...
      mandateOneTime:
        'En cliquant sur "{buttonLabel}", vous autorisez Tarifia Software, Inc., notre revendeur en ligne et marchand officiel, à prélever le montant indiqué ci-dessus sur le moyen de paiement sélectionné, et vous acceptez les {buyerTermsLink}. Il s\'agit d\'un paiement unique.',
    },
    form: {
      email: 'E-mail',
