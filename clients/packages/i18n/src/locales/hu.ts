export default {
  checkout: {
    footer: {
      ...
      mandateOneTime:
        'A(z) „{buttonLabel}” gombra kattintva felhatalmazza a Tarifia Software, Inc.-t, online viszonteladónkat és hivatalos kereskedőnket, hogy a kiválasztott fizetési módot megterhelje a fent látható összeggel, valamint elfogadja a(z) {buyerTermsLink} rendelkezéseit. Ez egy egyszeri terhelés.',
    },
    form: {
      email: 'E-mail cím',
