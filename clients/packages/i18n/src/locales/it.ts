export default {
  checkout: {
    footer: {
      ...
      mandateOneTime:
        'Cliccando su "{buttonLabel}", autorizzi Tarifia Software, Inc., il nostro rivenditore online e merchant of record, ad addebitare l\'importo sopra indicato sul metodo di pagamento selezionato e accetti i {buyerTermsLink}. Questo è un addebito unico.',
    },
    form: {
      email: 'Email',
