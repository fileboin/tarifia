...
const storage = new ExtensionStorage('group.com.tarifiasource.Tarifia')
...
const stub = (): never => {
  throw new Error(
    'You forgot to wrap your component in <TarifiaOrganizationProvider>.',
  )
}
...
export function TarifiaOrganizationProvider({ children }: PropsWithChildren) {
