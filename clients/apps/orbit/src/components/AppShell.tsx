...
import {
  ...
  SidebarProvider,
  SidebarTrigger,
} from '@tarifia-sh/ui/components/ui/sidebar'
import Link from 'next/link'
import { type ReactNode } from 'react'
import { DocsSidebar } from './Sidebar'

// Uses the shadcn Sidebar primitives (the same ones the Tarifia dashboard uses):
...
export function AppShell({ children }: { children: ReactNode }) {
  return (
    <SidebarProvider>
      ...
      <SidebarInset className="dark:border-tarifia-700 min-w-0 border border-gray-100 md:h-[calc(100svh-1rem)] md:overflow-y-auto">
        <Box
          as="header"
