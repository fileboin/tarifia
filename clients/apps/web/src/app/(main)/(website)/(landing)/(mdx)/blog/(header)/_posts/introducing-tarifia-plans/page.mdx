---
title: Introducing Tarifia Plans
slug: introducing-tarifia-plans
...
![introducing-tarifia-plans](/posts/blog/introducing-tarifia-plans/pricing.jpg)
...
Tarifia is going in the opposite direction.
...
| ------------------------------ | ----------- | --------------- | ---------------- | --------------------------- |
| Early Member _(grandfathered)_ | $0          | 4% + 40¢        | 0.5%             | Standard Support            |
...
At only $19K+/month in sales, Tarifia on Scale costs less per transaction than running payments and subscriptions through a standalone processor, but with Merchant of Record benefits included: international tax compliance, fraud and dispute prevention, and global coverage and compliance.
...
We launched Tarifia in September 2024. Compared to leading Merchant of Record (MoR) providers at the time, we lacked certain features in the beginning. To compensate we offered a discount from the industry standard of 5% + $0.50 with 4% + $0.40 plus 0.5% for subscriptions, calling it "Early Member" pricing.
...
Every Tarifia organization created before May 27, 2026, stays on the Early Member rate (4% + $0.40, plus 0.5% for subscriptions) indefinitely. However, for new organizations thereafter it's 5% + $0.50, including for organizations created after May 27 by customers who signed up earlier.
...
Tarifia is built open source, by developers, for developers. Transparency and product-led growth are the principles this post and our business are designed around.
...
So why are we increasing the Starter plan to 5% + $0.50? Our ambition at Tarifia is to always compete on quality instead of price. We're no longer behind on features compared to others and the cost of free to us has been increasing.
...
**As an existing Tarifia customer, what if I create a new organization after May 27?** Your earlier organizations will be grandfathered, but any new one created after May 27 will start on 5% + $0.50.
