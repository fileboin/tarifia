    ...
    <div className="flex flex-col gap-y-4">
      <div className="flex w-full flex-col gap-y-4">
        ...
        <div className="flex w-full flex-row items-center gap-6">
          <div className="dark:border-tarifia-700 grow border-t border-gray-200" />
      ...
      <div className="dark:text-tarifia-500 mt-6 text-center text-xs text-balance text-gray-400">
        By using Tarifia, you agree to our{' '}
        <a
          className="dark:text-tarifia-300 text-gray-600"
...
const LastUsedWrapper = ({
  ...
  <div className="relative">
    {show && (
      <span className="dark:bg-tarifia-900 dark:border-tarifia-600 absolute -top-3 -right-2 z-20 rounded-full border border-gray-200 bg-white px-2 py-0.5 text-xs text-black dark:text-white">
        Last used
      </span>
    )}
    {children}
