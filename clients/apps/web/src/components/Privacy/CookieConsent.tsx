  ...
  return (
    <>
      {consentGiven === 'undecided' && (
        <div className="shadow-3xl dark:bg-tarifia-950 dark:border-tarifia-700 dark:text-tarifia-500 fixed right-8 bottom-8 left-8 z-50 flex flex-col gap-y-4 rounded-2xl border border-gray-200 bg-gray-50 p-4 text-sm text-gray-500 md:left-auto md:max-w-96">
          <p>
