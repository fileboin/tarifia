    ...
    <div className="dark:bg-tarifia-800 rounded-2xl border bg-white p-8 text-center">
      {identityVerificationStatus === 'pending' ? (
        <>
          ...
          <p className="dark:text-tarifia-400 mx-auto mb-3 max-w-md text-sm text-gray-500">
        ...
        <>
          ...
          <p className="dark:text-tarifia-400 mx-auto text-sm text-gray-500">
        ...
        <>
          ...
          <p className="dark:text-tarifia-400 mx-auto mb-6 max-w-md text-sm text-gray-600">
        ...
        <>
          ...
          <p className="dark:text-tarifia-400 mx-auto mb-6 max-w-md text-sm text-gray-500">
