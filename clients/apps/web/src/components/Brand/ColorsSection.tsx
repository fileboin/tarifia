...
const COLORS: ColorEntry[] = [
  ...
  },
  {
    ...
    // luminescence of aurora light on the tarifia horizon.
    name: 'Ether',
    hex: '#7B8FD4',
    oklch: [62, 0.09, 270],
    flex: 1,
...
export function ColorsSection() {
  return (
    <SectionLayout label="Color Palette">
      <div className="dark:border-tarifia-700 flex w-full flex-col overflow-hidden rounded-sm border border-neutral-200 md:flex-row">
        {COLORS.map((color) => (
