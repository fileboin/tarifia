...
import { Modal, Text } from '@tarifia-sh/orbit'
    ...
    return (
      <div className="flex flex-col gap-6 p-8">
        ...
        <div className="flex flex-col items-center gap-0">
          ...
          <button
            className="dark:text-tarifia-500 dark:hover:text-tarifia-400 mx-auto cursor-pointer appearance-none p-2 text-center text-xs text-gray-500 hover:text-gray-700"
        ...
        <div className="flex flex-col gap-2">
          <label className="dark:text-tarifia-300 text-center text-sm font-medium text-gray-700">
              ...
              <InputOTPGroup>
                {Array.from({ length: 6 }).map((_, index) => (
                  <InputOTPSlot
                    key={index}
                    index={index}
                    className="dark:border-tarifia-600 h-12 w-12 border-gray-300 text-xl"
                  />
                ))}
              </InputOTPGroup>
            </InputOTP>
