...
export const SettingsGroup: React.FC<React.PropsWithChildren> = ({
  ...
  <div className="dark:ring-tarifia-700 dark:bg-tarifia-900 dark:divide-tarifia-700 w-full flex-col divide-y divide-gray-200 overflow-hidden rounded-2xl bg-transparent ring-1 ring-gray-200 dark:ring-1">
    {children}
  </div>
)
