...
import {
  ...
  AlertDialogTitle,
  AlertDialogTrigger,
} from '@tarifia-sh/ui/components/ui/alert-dialog'
  ...
  return (
    <div className="flex flex-col gap-y-4">
      <div className="flex flex-row items-center justify-between">
        ...
        <div className="dark:text-tarifia-400 flex flex-row items-center gap-x-4 space-x-4 text-gray-500">
          <AlertDialog>
...
const AccessTokensSettings = () => {
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      <div className="dark:bg-tarifia-800 dark:text-tarifia-500 flex flex-col gap-2 rounded-2xl bg-gray-100 p-6 text-sm text-gray-500">
