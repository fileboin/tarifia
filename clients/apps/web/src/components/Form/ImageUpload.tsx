      ...
      <div className="flex flex-col items-start gap-4">
        {imagePreviewSrc ? (
          ...
          <div
            ...
            className={twMerge(
              'dark:bg-tarifia-700 dark:border-tarifia-600 flex cursor-pointer flex-col items-center justify-center gap-y-2 rounded-xl border border-gray-200 bg-gray-50 hover:bg-gray-100',
              !height && !width ? 'h-32 w-32' : '',
            )}
            style={{
              maxWidth: width,
