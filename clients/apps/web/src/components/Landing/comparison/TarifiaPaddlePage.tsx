...
export const TarifiaVsPaddlePage = () => {
  const tocItems = [
  ...
  return (
    <ResourceLayout title="Tarifia vs Paddle" toc={tocItems}>
      <ResourceSection id="overview" title="Overview">
        ...
        <p className="dark:text-tarifia-300 text-gray-500">
          Both Tarifia and Paddle act as Merchant of Record (MoR), handling tax
          compliance and payments for you. However, Tarifia is built by developers
      ...
      <ResourceSection id="pricing" title="Pricing">
        ...
        <p className="dark:text-tarifia-300 text-sm text-gray-500">
          On paid plans, Tarifia&apos;s lower variable rates can save you
      ...
      <ResourceSection id="developer-experience" title="Developer Experience">
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <p className="dark:text-tarifia-300 text-gray-500">
              Tarifia is designed from the ground up for today&apos;s developers,
      ...
      <ResourceSection id="transparency" title="Transparency & Control">
        <div className="flex flex-col gap-4">
          ...
          <p className="dark:text-tarifia-300 text-gray-500">
            One of the biggest differences between Tarifia and Paddle is
            transparency. Tarifia is fully open source, giving you complete
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <div className="dark:bg-tarifia-800 flex flex-col gap-3 bg-gray-50 p-6">
            <h4 className="font-medium">With Tarifia</h4>
      ...
      <ResourceSection id="why-tarifia" title="Why Choose Tarifia?">
        <div className="flex flex-col gap-4">
          ...
          <p className="dark:text-tarifia-300 text-gray-500">
            If you&apos;re choosing a Merchant of Record, Tarifia offers
