...
export const TarifiaVsStripePage = () => {
  const tocItems = [
    ...
    { id: 'why-tarifia', title: 'Why Choose Tarifia?' },
  ]

  return (
    <ResourceLayout title="Tarifia vs Stripe" toc={tocItems}>
      <ResourceSection id="overview" title="Overview">
        ...
        <p className="dark:text-tarifia-300 text-gray-500">
          While Stripe is a powerful payment processor, Tarifia is a complete
          billing infrastructure platform built specifically for developers who
          want to monetize software. The key difference: Tarifia acts as a
      ...
      <ResourceSection id="comparison" title="Feature Comparison">
        <div className="dark:border-tarifia-700 overflow-x-auto border border-gray-200">
          <table className="w-full">
            <thead className="dark:bg-tarifia-800 bg-gray-50">
              <tr className="dark:border-tarifia-700 border-b border-gray-200">
                <th className="dark:border-tarifia-700 border-r border-gray-200 p-4 text-left font-medium">
                  Feature
                </th>
                <th className="dark:border-tarifia-700 border-r border-gray-200 p-4 text-center font-medium">
                  Tarifia
                </th>
                <th className="p-4 text-center font-medium">Stripe</th>
              </tr>
            </thead>
            <tbody className="dark:divide-tarifia-700 divide-y divide-gray-200">
              <tr>
                <td className="dark:border-tarifia-700 border-r border-gray-200 p-4">
                  Payment Processing
                </td>
                <td className="dark:border-tarifia-700 border-r border-gray-200 p-4 text-center">
      ...
      <ResourceSection id="pricing" title="Pricing">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="dark:border-tarifia-700 flex flex-col gap-4 border border-gray-200 p-6">
            <div className="flex flex-col gap-2">
              <h3 className="text-lg font-medium">Tarifia</h3>
            ...
            <ul className="dark:divide-tarifia-700 flex flex-col divide-y divide-gray-200">
              <li className="flex items-start gap-2 py-2">
                <CheckOutlined className="text-green-600" fontSize="small" />
                <span className="dark:text-tarifia-300 text-sm text-gray-600">
        ...
        <p className="dark:text-tarifia-300 text-sm text-gray-500">
          While Stripe&apos;s base processing fee appears lower, Tarifia&apos;s
      ...
      <ResourceSection id="developer-experience" title="Developer Experience">
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <p className="dark:text-tarifia-300 text-gray-500">
              Both Stripe and Tarifia offer excellent developer experiences, but
              Tarifia is purpose-built for software monetization with modern
              frameworks and ergonomic SDKs.
            </p>
          </div>
          <ul className="dark:border-tarifia-700 dark:divide-tarifia-700 divide-y divide-gray-200 border-y border-gray-200 [&>li]:py-3">
            <li>
              <h4 className="font-medium">6-line integration</h4>
              <p className="dark:text-tarifia-300 text-gray-500">
                Tarifia provides a 6-line integration with framework adapters,
            ...
            <li>
              ...
              <p className="dark:text-tarifia-300 text-gray-500">
                Tarifia provides native support for Next.js, BetterAuth, Laravel,
                and more.
              </p>
            </li>
            <li>
              ...
              <p className="dark:text-tarifia-300 text-gray-500">
                Tarifia is open source, so you can inspect and contribute to the
                codebase.
              </p>
            </li>
          </ul>
      ...
      <ResourceSection id="merchant-of-record" title="Merchant of Record">
        <div className="flex flex-col gap-4">
          ...
          <p className="dark:text-tarifia-300 text-gray-500">
            This is where Tarifia and Stripe fundamentally differ. Tarifia acts as
            the Merchant of Record, meaning we handle all the complexity of
            international sales tax, VAT, GST, and compliance.
          </p>
        </div>
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <div className="dark:bg-tarifia-800 flex flex-col gap-3 bg-gray-50 p-6">
            <h4 className="font-medium">With Tarifia (MoR)</h4>
            <ul className="flex flex-col gap-2">
              <li className="dark:text-tarifia-300 flex items-start gap-2 text-sm text-gray-600">
                <CheckOutlined className="text-green-600" fontSize="small" />
      ...
      <ResourceSection id="why-tarifia" title="Why Choose Tarifia?">
        <div className="flex flex-col gap-4">
          <h3 className="text-lg">
            Tarifia is purpose-built for software businesses
          </h3>
          <p className="dark:text-tarifia-300 text-gray-500">
            While Stripe is a powerful general-purpose payment processor, Tarifia
            is specifically designed for developers monetizing software. If you
            want to sell globally without worrying about tax compliance, Tarifia
        ...
        <div className="flex flex-col items-center gap-8">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="dark:text-tarifia-300 text-center text-gray-700 md:w-[440px]">
              Join thousands of developers who have chosen Tarifia for hassle-free
