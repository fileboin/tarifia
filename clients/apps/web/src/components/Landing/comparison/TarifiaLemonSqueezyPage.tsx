...
export const TarifiaVsLemonSqueezyPage = () => {
  const tocItems = [
  ...
  return (
    <ResourceLayout title="Tarifia vs Lemon Squeezy" toc={tocItems}>
      <ResourceSection id="overview" title="Overview">
        ...
        <p className="dark:text-tarifia-300 text-gray-500">
          Both Tarifia and Lemon Squeezy are Merchant of Record platforms that
          handle tax compliance globally. While Lemon Squeezy caters to solo
          creators and indie hackers, Tarifia is built for developers who need
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <p className="dark:text-tarifia-300 text-gray-500">
              ...
              getting started quickly. However, Tarifia provides both simplicity
      ...
      <ResourceSection id="scalability" title="Scalability & Features">
        <div className="flex flex-col gap-4">
          ...
          <p className="dark:text-tarifia-300 text-gray-500">
            ...
            creators, Tarifia is designed to grow with you from your first sale to
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <div className="dark:bg-tarifia-800 flex flex-col gap-3 bg-gray-50 p-6">
            <h4 className="font-medium">Tarifia at Scale</h4>
      ...
      <ResourceSection id="why-tarifia" title="Why Choose Tarifia?">
        <div className="flex flex-col gap-4">
          ...
          <p className="dark:text-tarifia-300 text-gray-500">
            ...
            quickly outgrow its limitations. Tarifia gives you the same simple
