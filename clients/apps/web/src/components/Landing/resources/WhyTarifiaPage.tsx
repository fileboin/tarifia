...
const FAQItem = ({
  ...
  return (
    <div className="dark:border-tarifia-700 hover:dark:bg-tarifia-800 border-b border-gray-200 last:border-b-0 hover:bg-gray-50">
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="group flex w-full cursor-pointer items-center gap-6 p-4 text-left transition-opacity"
      >
        <div className="dark:border-tarifia-700 dark:text-tarifia-400 hidden h-11 w-11 shrink-0 items-center justify-center rounded-full border border-gray-200 font-mono text-sm text-gray-600 transition-colors lg:flex">
          {number}
        </div>
      ...
      >
        <div className="pr-12 pb-8 pl-4 lg:pl-[84px]">
          <p className="dark:text-tarifia-400 leading-relaxed text-gray-700">
            {answer}
          </p>
        </div>
      </div>
...
export const WhyTarifiaPage = () => {
  const tocItems = [
    ...
    { id: 'why-switch', title: 'Why switch to Tarifia?' },
    ...
    >
      <ResourceSection id="introduction" title="Introduction">
        ...
        <p className="dark:text-tarifia-300 text-gray-500">
          Tarifia is an open-source billing infrastructure platform designed
          specifically for developers who want to monetize their software
          without the complexity of traditional payment systems.
        </p>
        <blockquote className="dark:border-tarifia-700 flex flex-col gap-y-4 border border-gray-200 p-4">
          <p>
            The speed at which Tarifia is executing on the financial
        ...
        <div className="flex flex-col gap-2">
          ...
          <Link
            ...
            className="w-fit border-b border-black pb-0.5 dark:border-white"
          >
            Compare Tarifia vs. Lemon Squeezy
            <ArrowOutwardOutlined className="ml-2" fontSize="inherit" />
          </Link>
        </div>
      </ResourceSection>
      ...
      <ResourceSection id="developer-experience" title="Developer Experience">
        ...
        <div className="flex flex-col gap-2">
          <h3>Open Source</h3>
          <p className="dark:text-tarifia-300 text-gray-500">
            Tarifia is open source, licensed under the Apache 2.0 license. We
            believe that the best way to build a great developer experience is
            to build it with the community.
          </p>
          <Link
            href="https://github.com/tarifiasource/tarifia"
            target="_blank"
            className="w-fit border-b border-black pb-0.5 dark:border-white"
          >
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="dark:text-tarifia-300 text-gray-500">
              ...
              as Stripe), Tarifia does not add any extra fees or markup.
            </p>
          </div>
        </div>
      </ResourceSection>
      ...
      {/* Why Switch */}
      <ResourceSection id="why-switch" title="Why switch to Tarifia?">
        <div className="flex flex-col gap-2">
          ...
          <p className="dark:text-tarifia-300 text-gray-500">
            ...
            enough, our versatile SDKs allow you to integrate with Tarifia in any
            way you want.
          </p>
        </div>
        <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="dark:text-tarifia-300 text-gray-500">
            Tarifia is built by developers, for developers. We listen to your
      ...
      <ResourceSection id="who-switches" title="Who else is switching?">
        <div className="flex flex-col gap-8">
          ...
          <div className="dark:border-tarifia-700 dark:divide-tarifia-700 grid grid-cols-3 items-center divide-x divide-gray-200 border border-gray-200">
            {logos.map(({ logo, href }, index) => (
              <Link
                key={index}
                className="dark:hover:bg-tarifia-800 flex h-full items-center justify-center p-4 hover:bg-gray-100"
                href={href}
                target="_blank"
              >
                {logo}
      ...
      <div className="dark:border-tarifia-700 flex flex-col border-t border-gray-200 pt-16">
        <FAQItem
          number="01"
          question="Do I still pay Stripe fees if I use Tarifia?"
          answer="Tarifia's platform fee covers Stripe's processing costs. Stripe's additional fees, like +1.5% for international cards, are passed through at cost. Your platform fee depends on your plan; see the pricing guide for details."
        />
        <FAQItem
          number="02"
          question="Is Tarifia built on Stripe? Why not just use Stripe directly?"
          answer="We use Stripe rails for processing reliability and coverage. Processing ≠ the business layer. Tarifia is the MoR + billing + entitlements + unit-economics layer you'd otherwise build or buy on top of Stripe."
        />
        <FAQItem
          number="03"
          question="How are payouts handled internationally?"
          answer="All payments are made to Tarifia as the Merchant of Record. We use Stripe Connect Express to make payouts across more countries than Stripe Payments supports directly."
        />
        <FAQItem
          number="04"
