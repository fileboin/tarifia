...
const MobileNav = ({
  ...
  const header = (
    <div className="dark:bg-tarifia-900 sticky top-0 right-0 left-0 flex w-full flex-row items-center justify-between bg-gray-50 p-4">
  ...
  return (
    <div className="dark:bg-tarifia-900 relative z-20 flex w-screen flex-col items-center justify-between bg-gray-50 md:hidden">
      {mobileNavOpen ? (
        <div className="relative flex h-full w-full flex-col">
          {header}
          <div className="dark:bg-tarifia-900 flex h-full flex-col bg-gray-50 px-4">
            <DashboardSidebar
              organization={organization}
              organizations={organizations}
              type={type}
...
export const DashboardBody = ({
  ...
  return (
    <motion.div
      ...
      exit="exit"
    >
      <div className="dark:bg-tarifia-900 dark:border-tarifia-800 relative flex min-w-0 flex-2 flex-col items-center rounded-2xl border-gray-200 bg-white px-4 md:overflow-y-auto md:border md:px-8 md:shadow-xs">
        <div
          className={twMerge(
      ...
      {contextView ? (
        <motion.div
          ...
          className={twMerge(
            'dark:bg-tarifia-900 dark:border-tarifia-800 hidden w-full flex-1 overflow-y-auto rounded-2xl border border-gray-200 bg-white md:block md:max-w-[320px] md:shadow-xs xl:max-w-[440px]',
            contextViewClassName,
          )}
        >
          {contextView}
