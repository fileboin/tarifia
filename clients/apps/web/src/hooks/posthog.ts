...
export const usePostHog = (): TarifiaHog => {
  ...
  const capture: TarifiaHog['capture'] = useCallback(
  ...
  const identify: TarifiaHog['identify'] = useCallback(
    (user) => {
  ...
  const logout: TarifiaHog['logout'] = useCallback(() => {
