# Contributing to Tarifia

Thank you for your interest in contributing to Tarifia! This document provides guidelines and information for contributing to our open-source project.
...
- **Structure**: Follow the modular structure in `server/tarifia/`
...
By contributing to Tarifia, you agree that your contributions will be licensed under the same license as the project.
