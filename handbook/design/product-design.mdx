...
description: "How the design principles apply to the Tarifia product"
---

The Tarifia product should feel like a precision instrument. Not software that processes billing. An instrument that measures, captures, and converts with exactness.
...
Every screen, every state, every edge case is designed with the same precision as the primary flow. Empty states are not afterthoughts. Error states are not apologies. Every moment a founder encounters the product is a moment they are forming a judgment about Tarifia's precision. We treat every state as primary.
...
The invoice is the most tangible expression of Tarifia in the world. It lands in a founder's customer's inbox with the Tarifia system behind it. It should be the most precisely designed document in that inbox. Typographically exact, informationally clear, unmistakably considered.
