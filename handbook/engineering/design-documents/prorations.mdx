...
| **Monthly to yearly** |  | Would be a switch of products in Tarifia |  | Would be a switch of products in Tarifia |
| **Yearly to monthly** | Sets billing anchor to “now” (when the downgrade happened) and starts the monthly subscription from then

+ adds remaining amount to customer balance | Would be a switch of products in Tarifia |  | Would be a switch of products in Tarifia |
...
Use existing `BillingEntry` data model as described in [tarifia#6118](https://github.com/tarifiasource/tarifia/issues/6118).
...
- Data
    ...
    ```json
    {
      ...
      "object": "invoice",
      "account_country": "US",
      "account_name": "francois@tarifia.sh sandbox",
      ...
      "customer_email": "francois+cr5@tarifia.sh",
      "customer_metadata": {},
      "customer_name": "FV",
      "customer_phone": null,
