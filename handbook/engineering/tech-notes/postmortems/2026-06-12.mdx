---
title: "2026-06-12"
description: "An incident report detailing the outage of the Tarifia platform on June 12, 2026, its impact, root cause analysis, and actions taken to prevent future occurrences."
---

## Summary

On Jun 12, 2026 at 13:17 UTC, the Tarifia platform was down for an hour.
...
- The Tarifia dashboard, API, and checkout infrastructure were unavailable.
...
- **13:17:46**: Tarifia fully down. **Incident starts**
...
- **14:18:00**: Tarifia confirmed to be up but with degraded performance on metrics endpoints
