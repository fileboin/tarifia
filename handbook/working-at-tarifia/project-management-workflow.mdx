...
| `tarifia-team`            | Reserved for our internal team                                           |
...
| --------------------- | -------------- | ----------------------------------------------------------------------------------------------------------  |
| **tarifia**             | 🟢 Public      | Default to public for all our features, tasks and bugs                                                      |
| **tarifia-internal**    | 🔒 Private     | Internal tasks we need to keep private, e.g customer-specific data, internal ops or surprise launches       |
| **tarifia-adapters**    | 🟢 Public      | *Redirected/submitted to `tarifia`*                                                                           |

Making it easy to coordinate our efforts in public with some exceptions in `tarifia-internal` only available to the team.
...
**Actions:**
- If it's a support request: ask the user to write to support@tarifia.com and close the issue.
