module "sandbox_s3_buckets" {
  ...
  environment              = "sandbox"
  allowed_origins          = ["https://sandbox.tarifia.sh"]
  public_files_bucket_name = "tarifia-public-sandbox-files"
}
...
module "sandbox_application_access" {
  ...
  username = "tarifia-sandbox-files"
  buckets = {
    customer_invoices = { name = "tarifia-sandbox-customer-invoices" }
    customer_receipts = { name = "tarifia-sandbox-customer-receipts" }
    payout_invoices   = { name = "tarifia-sandbox-payout-invoices" }
    files             = { name = "tarifia-sandbox-files", description = "Policy used by our SANDBOX app for downloadable benefits. Keep permissions to a bare minimum." }
    public_files      = { name = "tarifia-public-sandbox-files", description = "Policy used by our SANDBOX app for public uploads -products medias and such-. Keep permissions to a bare minimum." }
    logs              = { name = "tarifia-sandbox-logs", description = "Policy used by our SANDBOX app to write OpenTelemetry spans to S3 for long-term backup." }
  }
}
...
module "sandbox_image_resizer" {
  ...
  function_name            = "tarifia-sandbox-image-resizer"
...
module "sandbox_cloudfront_assets" {
  ...
  name                           = "tarifia-sandbox-public-files"
  domain                         = "sandbox-uploads.tarifia.sh"
  ...
  cors_allowed_origins           = ["https://sandbox.tarifia.sh"]
...
module "sandbox_cloudfront_cdn" {
  ...
  name                           = "tarifia-sandbox-cdn"
  domain                         = "sandbox-cdn.tarifia.sh"
  cloudflare_zone_id             = "22bcd1b07ec25452aab472486bc8df94"
...
import {
  ...
  id = "arn:aws:iam::975049931254:policy/tarifia-sandbox-customer-invoices"
}

import {
  to = module.sandbox_application_access.aws_iam_policy.customer_receipts
  id = "arn:aws:iam::975049931254:policy/tarifia-sandbox-customer-receipts"
}

import {
  to = module.sandbox_application_access.aws_iam_policy.files
  id = "arn:aws:iam::975049931254:policy/tarifia-sandbox-files"
}

import {
  to = module.sandbox_application_access.aws_iam_policy.logs
  id = "arn:aws:iam::975049931254:policy/tarifia-sandbox-logs"
}

import {
  to = module.sandbox_application_access.aws_iam_policy.payout_invoices
  id = "arn:aws:iam::975049931254:policy/tarifia-sandbox-payout-invoices"
}

import {
  to = module.sandbox_application_access.aws_iam_policy.public_files
  id = "arn:aws:iam::975049931254:policy/tarifia-public-sandbox-files"
}

import {
  to = module.sandbox_application_access.aws_iam_user_policy_attachment.customer_invoices
  id = "tarifia-sandbox-files/arn:aws:iam::975049931254:policy/tarifia-sandbox-customer-invoices"
}

import {
  to = module.sandbox_application_access.aws_iam_user_policy_attachment.customer_receipts
  id = "tarifia-sandbox-files/arn:aws:iam::975049931254:policy/tarifia-sandbox-customer-receipts"
}

import {
  to = module.sandbox_application_access.aws_iam_user_policy_attachment.files
  id = "tarifia-sandbox-files/arn:aws:iam::975049931254:policy/tarifia-sandbox-files"
}

import {
  to = module.sandbox_application_access.aws_iam_user_policy_attachment.logs
  id = "tarifia-sandbox-files/arn:aws:iam::975049931254:policy/tarifia-sandbox-logs"
}

import {
  to = module.sandbox_application_access.aws_iam_user_policy_attachment.payout_invoices
  id = "tarifia-sandbox-files/arn:aws:iam::975049931254:policy/tarifia-sandbox-payout-invoices"
}

import {
  to = module.sandbox_application_access.aws_iam_user_policy_attachment.public_files
  id = "tarifia-sandbox-files/arn:aws:iam::975049931254:policy/tarifia-public-sandbox-files"
}

import {
  to = module.sandbox_image_resizer.aws_iam_role.this
  id = "tarifia-sandbox-image-resizer"
}

import {
  to = module.sandbox_image_resizer.aws_iam_role_policy.this
  id = "tarifia-sandbox-image-resizer:tarifia-sandbox-image-resizer"
}
...
import {
  to = module.sandbox_cloudfront_assets.cloudflare_dns_record.acm_validation["sandbox-uploads.tarifia.sh"]
...
import {
  to = module.sandbox_cloudfront_cdn.cloudflare_dns_record.acm_validation["sandbox-cdn.tarifia.sh"]
