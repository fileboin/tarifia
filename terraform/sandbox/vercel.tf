# =============================================================================
# Vercel — Sandbox frontend (sandbox.tarifia.sh)
# =============================================================================
...
import {
  to = module.vercel.vercel_project_domain.this["sandbox.tarifia.sh"]
  id = "prj_HjPbSesm9rpLRPaK6bLOwVqQzQBD/sandbox.tarifia.sh"
}

import {
  to = module.vercel.cloudflare_dns_record.this["sandbox.tarifia.sh"]
...
module "vercel" {
  ...
  config = {
    next_public_api_url                             = "https://sandbox-api.tarifia.sh"
    next_public_backoffice_url                      = "https://sandbox-api.tarifia.sh/backoffice"
    ...
    s3_public_images_bucket_hostname                = "tarifia-public-sandbox-files.s3.amazonaws.com"
    s3_public_images_bucket_port                    = null
    s3_public_images_bucket_pathname                = "/product_media/**"
    s3_upload_origins                               = "https://tarifia-sandbox-files.s3.amazonaws.com https://tarifia-public-sandbox-files.s3.amazonaws.com"
  ...
  environment_variables = [
    { key = "NEXT_PUBLIC_FRONTEND_BASE_URL", value = "https://sandbox.tarifia.sh" },
    { key = "NEXT_PUBLIC_ENVIRONMENT", value = "sandbox" },
    { key = "TARIFIA_AUTH_COOKIE_KEY", value = "tarifia_sandbox_session" },
    { key = "NEXT_PUBLIC_PRODUCT_LINK_BASE_URL", value = "https://sandbox.tarifia.sh/api/checkout?price=" },
