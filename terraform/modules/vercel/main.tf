...
locals {
  ...
  shared_environment_variables = [
    { key = "SENTRY_ORG", value = "tarifia-sh", target = ["production", "preview"] },
  ...
  config_environment_variables = [
    ...
    { key = "TARIFIA_CHECKOUT_EMBED_SCRIPT_ALLOWED_ORIGINS", value = var.config.tarifia_checkout_embed_script_allowed_origins },
    { key = "TARIFIA_OPENAPI_SCHEMA_URL", value = var.config.tarifia_openapi_schema_url },
  ...
  secret_environment_variables = [
    ...
    { key = "TARIFIA_PREVIEW_ACCESS_TOKEN", value = var.secrets.tarifia_preview_access_token, target = ["preview"], sensitive = true },
  ]
