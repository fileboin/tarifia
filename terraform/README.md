# Tarifia Infrastructure as Code (IaC)
...
State, Secrets and Runs are directly managed on [HCP Terraform Cloud](https://app.terraform.io/app/tarifia-sh/workspaces/tarifia).
...
resource "render_env_group" "backend_production" {
  ...
  env_vars = {
    # ...
    TARIFIA_MY_VARIABLE = { value = var.my_variable }
  }
  # ...
}
```
