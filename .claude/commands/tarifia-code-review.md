...
prompt: |
  SECURITY REVIEW for Tarifia codebase.
...
subagent_type: "feature-dev:code-reviewer"
prompt: |
  CONVENTIONS REVIEW for Tarifia codebase.

  Review these changed files against Tarifia conventions:
  [INSERT CHANGED FILES LIST]

  **Backend Conventions (server/tarifia/):**
  ...
  **API Conventions:**
  ...
  - Use TarifiaRequestValidationError for 422 errors
...
subagent_type: "feature-dev:code-reviewer"
prompt: |
  SIMPLIFICATION REVIEW for Tarifia codebase.
